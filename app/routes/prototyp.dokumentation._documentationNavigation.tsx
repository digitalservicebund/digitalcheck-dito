...
export default function LayoutWithDocumentationNavigation() {
  ...
  return (
    <div className="parent-bg-blue bg-ds-blue flex justify-center pt-32">
...
function NavItem({
  ...
  const liClassNames = twJoin(
    ...
    isCurrent
      ? "border-l-ds-dark-blue pointer-events-none"
      : "border-l-ds-blue",
  ...
  const itemClassNames = customTwMerge(
    "bg-ds-blue w-full ds-label-02-reg p-16 flex gap-x-4 items-center hover:underline hover:bg-ds-mid-blue active:bg-white focus-visible:shadow-[inset_0px_0px_0px_4px] focus:shadow-ds-dark-blue",
