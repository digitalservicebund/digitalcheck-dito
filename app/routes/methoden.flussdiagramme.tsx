...
function TableOfContentsLayout({
  children,
  sidebar,
}: Readonly<TableOfContentsLayoutProps>) {
  return (
    <div className="grid grid-cols-1 gap-y-40 sm:grid-cols-[1fr_minmax(184px,256px)] md:my-40">
      ...
      <div className="order-first ml-20 sm:sticky sm:top-40 sm:order-none sm:ml-0 sm:self-start sm:px-40">
        {sidebar}
      </div>
    </div>
  );
...
function Sidebar() {
  ...
  useEffect(() => {
    ...
    document.querySelectorAll("section[id], li[id]").forEach((section) => {
  ...
  const liClass = "ds-link-02-reg no-underline data-active:ds-link-02-bold";

  return (
    <nav ref={navRef} aria-labelledby="sidebar-label" className="space-y-16">
      <div id="sidebar-label" className="ds-label-01-bold">
        Inhalt
      </div>
      <ol className="list-unstyled list-none space-y-16">
        <li className={liClass}>
          <a href="#aufbau">Aufbau</a>
        </li>
        <li className={"ds-link-02-reg space-y-16 no-underline"}>
          <a href="#anleitung">Anleitung</a>
          <ol className="mt-16 space-y-16">
            <li className={liClass}>
              <a href="#schritt-1">Format</a>
            </li>
            <li className={liClass}>
              <a href="#schritt-2">Akteure</a>
            </li>
            <li className={liClass}>
              <a href="#schritt-3">Ziel & Perspektive der Visualisierung</a>
            </li>
            <li className={liClass}>
              <a href="#schritt-4">Start und Ende definieren</a>
            </li>
            <li className={liClass}>
              <a href="#schritt-5">Prozess abbilden</a>
            </li>
            <li className={liClass}>
              <a href="#schritt-6">Informationen ergänzen</a>
            </li>
          </ol>
        </li>
      </ol>
  ...
  return (
    <>
      ...
      <Container className="sm:pr-0">
        <TableOfContentsLayout sidebar={<Sidebar />}>
          <section
