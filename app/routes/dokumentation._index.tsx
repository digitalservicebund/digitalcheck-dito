          ...
          <FeatureList>
            ...
            <Feature>
              ...
              <p>
                ...
                <strong>flexibel im Formular</strong> oder speichern Sie sie als{" "}
                <strong>Word-Datei</strong>. Abschließend senden Sie die Angaben
                an den NKR.
              </p>
            </Feature>
            <Feature>
          ...
          <NumberedList>
            <NumberedList.Item className={"space-y-8"}>
              ...
              <p>
                ...
                Prinzipien für digitaltaugliche Gesetzgebung basiert. Alternativ
                können Sie die Dokumentation als Word-Datei herunterladen und
                bearbeiten.
              </p>
            </NumberedList.Item>
            <NumberedList.Item className={"space-y-8"}>
      ...
      <div className="bg-blue-100 py-80 max-lg:px-16">
        <Container className="bg-white">
          ...
          >
            ...
            <p>
              <strong>Zweite Meinung nutzen:</strong> Teilen Sie Zwischenstände
              mit Kollegen und Kolleginnen, um Feedback einzuholen.
            </p>
            <p>
              <strong>Visualisierung einbeziehen:</strong> Verwenden Sie
              bestehende Visualisierungen mit den fünf Prinzipien als Grundlage
              und senden Sie sie am Ende mit an den NKR.
            </p>
          </InfoBox>
        </Container>
      </div>
