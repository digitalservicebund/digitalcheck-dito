...
export default function PrototypeDocumentationPrinciple2() {
  ...
  return (
    <Container className="pt-0">
      ...
      />
      <DetailsSummary
        title={principle2.details.title}
        content={principle2.details.text}
        className="mb-40"
      />
      <form>
        <fieldset className="ds-stack ds-stack-24">
          ...
          {showPositiveFields && (
            <>
              <RichText markdown={principle2.hint} className="mt-40" />
              <DetailsSummary
                title={principle2.example.title}
                content={principle2.example.text}
              />
      ...
      <ButtonContainer className="pt-40">
        <Button href={ROUTE_PROTOTYPE_DOCUMENTATION_PRINCIPLE_3.url}>
          {nextButton}
        </Button>
        <Button
