  ...
  return (
    <>
      ...
      <main>
        ...
        >
          <div className="my-40 space-y-40 lg:space-y-80">
            <section
            ...
            >
              ...
              `}
                      ...
                      <p>
                        ...
                        Informationsflüsse der Akteure nacheinander in die
                        Bahnen ein. Formulieren Sie die Aktivitäten möglichst
                        aktiv, z. B. „Akteur X beantragt Y“ oder „Akteur X
                        versendet Y“.
                      </p>
                      <ImageBox
                        image={{
            ...
            <section className="scroll-my-40" id="video-anleitung">
              ...
              <p className="mb-40">
                Im Video sehen Sie die zuvor erklärten Schritte in kompakter
                Form – diesmal am Beispiel Einbürgerung. So wird deutlich, wie
                sich die Methode aus dem Führerschein-Beispiel auch auf andere
