    ...
    <>
      ...
      <div className="space-y-8">
        ...
        <p>
          ...
          Mitgliedsstaaten verpflichtet, Anforderungen an die Interoperabilität
          zu berücksichtigen.
        </p>
      </div>
      ...
      <div className="space-y-8">
        ...
        <p>
          ...
          werden. Denn nur wenn Sie die Interoperabilität von Anfang an
          mitdenken, schaffen Sie die rechtliche Grundlage für Behörden, um
          europaweit Daten auszutauschen und funktionierende,
          grenzüberschreitende Verwaltungsleistungen anzubieten. Abschließend
      ...
      <div className="space-y-8">
        ...
        <ul>
          <li>
            Können nach der aktuellen Rechtslage andere EU-Bürgerinnen und
            -Bürger ein digitales Angebot in diesem Zusammenhang nutzen?
          </li>
