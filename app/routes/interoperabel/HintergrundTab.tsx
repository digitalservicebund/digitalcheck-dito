...
export function HintergrundTab() {
  return (
    <>
      ...
      <div className="space-y-8">
        ...
        <p>
          ...
          berücksichtigen, müssen öffentliche Stellen die Interoperabilität
          neuer Dienste berücksichtigen.
        </p>
        <DetailsSummary title="Welche positiven Effekte sollen dadurch erreicht werden?">
          <div className="space-y-8">
            <p>
              ...
              Bürgerinnen und Bürger, Unternehmen und Verwaltungen. Bis 2030
              soll eine verbesserte Interoperabilität öffentliche Verwaltungen
              enger vernetzen und transeuropäische digitale Dienste fördern.
            </p>
            <p>Quellen:</p>
            <ul>
              <li>
                <NewTabLink to="https://eur-lex.europa.eu/legal-content/DE/TXT/?uri=CELEX%3A32024R0903">
                  EUR Lex - Verordnung für ein interoperables Europa (EU)
                  2024/903
                </NewTabLink>
              </li>
              <li>
      ...
      <div className="space-y-8">
        ...
        <p>
          ...
          Schritt, in dem Sie einige Fragen zu Inhalten der Regelung
          beantworten.
        </p>
        <p>
          Wichtig ist, dass Sie die Interoperabilität von Anfang an mitdenken.
          So schaffen Sie die rechtliche Grundlage für Behörden, um europaweit
          Daten auszutauschen und funktionierende, grenzüberschreitende
        ...
        <p>
          Die Interoperabilitäts-Bewertung ist schließlich ein Online-Formular
          auf{" "}
        ...
        <DetailsSummary title="Was ist eine verbindliche Anforderung?">
          <div className="space-y-8">
            <p>
              ...
              eine Richtlinie, ein Verbot oder eine Beschränkung sein. Eine
              exakte Definition finden Sie in der{" "}
            ...
            <p>
              ...
              Interoperabilitätsbewertung durchzuführen, sie zu dokumentieren
              und den Bericht einzureichen.
            </p>
            <p>Weitere Quellen:</p>
            <ul>
              <li>
      ...
      <div className="space-y-8">
        ...
        <ul>
          <li>
            ...
            Regelungen sollten sich dabei nicht gegenseitig widersprechen,
            sondern gegenseitige Anerkennung sicherstellen und dafür sorgen,
            dass rechtliche Rahmenbedingungen jeweils zusammen passen.
          </li>
          <li>
            <strong>Organisatorische Interoperabilität</strong>: Gesetze sollten
            die Zusammenarbeit zwischen den Verwaltungsstellen fördern, indem
            sie gemeinsame Geschäftsprozesse und Modelle festlegen. Dies
            beinhaltet die Koordination von Aufgaben und die Klärung der Rollen.
          </li>
          <li>
            ...
            sicherzustellen, dass die Bedeutung der ausgetauschten Daten von
            allen Systemen die gleiche ist.
          </li>
          <li>
