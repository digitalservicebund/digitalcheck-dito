...
export const InteroperableLoesungenTab = () => (
  <section className="space-y-40">
    ...
    <p>
      ...
      effizient und sicher Daten über Ländergrenzen hinweg austauschen können.
      So können digitale öffentliche Dienste – wie die gegenseitige Anerkennung
      von Diplomen oder den Austausch von Fahrzeugdaten – nahtlos und ohne
      bürokratische Hürden für Bürgerinnen und Bürger und Unternehmen angeboten
      werden.
    </p>
    <p>
