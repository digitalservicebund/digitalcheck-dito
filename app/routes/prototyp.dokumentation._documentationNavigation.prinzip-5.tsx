...
export default function PrototypeDocumentationPrinciple5() {
  ...
  return (
    <Container className="pt-0">
      <MetaTitle prefix={ROUTE_PROTOTYPE_DOCUMENTATION_PRINCIPLE_5.title} />
      <IntermediateSaveLink />
      <Heading
        text={principle5.headline}
        tagName="h1"
        look="ds-heading-02-reg"
        className="mb-16"
      />
      <DetailsSummary
        title={principle5.details.title}
        content={principle5.details.text}
        className="mb-40"
      />
      <form>
        <fieldset className="ds-stack ds-stack-24">
          ...
          {showPositiveFields && (
            <>
              ...
              <DetailsSummary
                title={principle5.example.title}
                content={principle5.example.text}
              />
