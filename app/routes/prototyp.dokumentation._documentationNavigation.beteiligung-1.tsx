...
const { participation1, nextButton } = prototypeDocumentation;
const { headline, text, textfieldExplanationLabel } = participation1;

export function meta() {
  return constructMetaTitle(
    ROUTE_PROTOTYPE_DOCUMENTATION_PARTICIPATION_1.title,
  );
}
