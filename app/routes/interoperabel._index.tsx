            ...
            >
              ...
              <div className="space-y-8">
                ...
                <p>
                  ...
                  zusammenarbeiten. Die Verordnung soll Insellösungen verhindern
                  und schafft deshalb einen gemeinsamen Rahmen für die
                  Zusammenarbeit. Seit Anfang 2025 sind die Mitgliedsstaaten
                  verpflichtet, Anforderungen an die Interoperabilität zu
                  berücksichtigen.
                </p>
              </div>
              ...
              <div className="space-y-8">
                ...
                <ul>
                  <li>
                    Können nach der aktuellen Rechtslage andere EU-Bürgerinnen
                    und -Bürger ein digitales Angebot in diesem Zusammenhang
                    nutzen?
                  </li>
              ...
              <p>
                ...
                wesentliche Inhalt besteht aus fünf Fragen. Die Bewertung fragt
                nach sogenannten „{/* TODO: helper function for links */}
                <Link
                  className="text-link"
                  to={getTabAnchorLink(
                    backgroundTabId,
            ...
            >
              ...
              <div className="space-y-8">
                ...
                <p>
                  ...
                  Daten zwischen den Mitgliedstaaten auszutauschen. Um digitale
                  Potenziale und Hindernisse zu berücksichtigen, müssen
                  öffentliche Stellen die Interoperabilität neuer Dienste
                  berücksichtigen.
                </p>
                <DetailsSummary title="Welche positiven Effekte sollen dadurch erreicht werden?">
                  <div className="space-y-8">
                    <p>
                      ...
                      von Lösungen, indem sie bürokratische Hürden abbauen. Dies
                      spart Kosten und Zeit für Bürgerinnen und Bürger,
              ...
              <div className="space-y-8">
                ...
                <p>
                  ...
                  Interoperabilität auswirkt: Der wesentliche Inhalt besteht aus
                  fünf Fragen. Die Bewertung fragt nach sogenannten „
                  <Link
                    className="text-link"
                    to={getTabAnchorLink(
                      backgroundTabId,
              ...
              <div className="space-y-8">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <ul>
                      <li>
                        eine digitale Umsetzung vorgesehen oder davon betroffen
                        ist
                      </li>
                      <li>
              ...
              <div className="space-y-8">
                ...
                <ul>
                  <li>
                    ...
                    Datenaustausch schaffen. Regelungen sollten sich dabei nicht
                    gegenseitig widersprechen, sondern gegenseitige Anerkennung
                    sicherstellen und dafür sorgen, dass rechtliche
                    Rahmenbedingungen jeweils zusammen passen.
                  </li>
                  <li>
                    <strong>Organisatorische Interoperabilität</strong>: Gesetze
                    sollten die Zusammenarbeit zwischen den Verwaltungsstellen
                    fördern, indem sie gemeinsame Geschäftsprozesse und Modelle
                    festlegen. Dies beinhaltet die Koordination von Aufgaben und
