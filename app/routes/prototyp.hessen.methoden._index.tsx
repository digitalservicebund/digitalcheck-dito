...
import { methodStepsItems } from "~/utils/listProcessingPrototype.ts";
...
export default function PrototypeMethoden() {
  return (
    <>
      <Hero
        subtitle={methods.subtitle}
        title="Erarbeiten eines digitaltauglichen Regelungsvorhabens in Hessen"
      />
