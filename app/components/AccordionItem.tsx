...
export default function AccordionItem({
  ...
  return (
    <details className="group border-t-2 border-t-blue-800" id={id}>
      <summary className="flex w-full cursor-pointer items-center justify-between p-24 group-open:bg-blue-200 hover:bg-blue-200 focus-visible:bg-blue-200 focus-visible:outline focus-visible:outline-4 focus-visible:outline-blue-800 [&::-webkit-details-marker]:hidden">
