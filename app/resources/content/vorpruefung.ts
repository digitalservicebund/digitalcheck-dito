      ...
      relevance: {
        ...
        content: dedent`
          <ul class="space-y-24">
            ...
            <li><strong>Rechtliche Grundlage:</strong> Seit Juni 2024 ist es verpflichtend Regelungsvorhaben auf Bundesebene auf Digitaltauglichkeit zu prüfen. Die Grundlage dafür ist das Onlinezugangsgesetz (OZG) von 2017. Zusätzlich müssen ab Januar 2025 bestimmte Regelungsvorhaben die Anforderungen an Interoperabilität auf EU-Ebene unterstützen. Dies ergibt sich aus der <a href="https://eur-lex.europa.eu/legal-content/DE/TXT/?uri=CELEX:32024R0903" >EU-Verordnung für ein interoperable Europa (EU) 2024/903</a>.</li>
          </ul>
          `,
      },
    },
