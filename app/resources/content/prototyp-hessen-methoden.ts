...
export const methods = {
  ...
  steps: {
    items: [
      ...
      // },
      {
        headline: { text: "Prüfen der Wirtschaftlichkeit" },
        text: "Prüfen Sie zunächst die voraussichtlichen Kosten und Einsparungen, die durch den Gesetzesentwurf entstehen. Analysieren Sie anschließend die Auswirkungen auf den Staatshaushalt, die Verwaltung sowie auf Unternehmen und Verbraucher. Bewerten Sie abschließend, ob der erwartete Nutzen die entstehenden Kosten rechtfertigt.",
      },
      {
        isSubstep: true,
        label: { text: "Kostenschätzung" },
        headline: {
          text: "Schätzen Sie die Kosten für den Landeshaushalt",
        },
        text: "Nutzen Sie als Hilfestellung die folgende Auflistung üblicherweise anfallender Posten und das Realbeispiel.",
        buttons: [
          {
            text: "Hilfestellung zur Kostenschätzung",
