...
const currentItems = `
### Strukturierung der Frühphase für Regelungsvorhaben

Ein gutes, frühzeitiges Verständnis von Anforderungen und Umfeld ist die Basis dafür, Gesetze wirksam und effizient umzusetzen. Wie können wir diese frühe Phase in der Rechtsetzung, für Legistinnen und Legisten, besser strukturieren und unterstützen?<br>
[Mitarbeiten an diesem Thema](${generateMailtoLink("Strukturierung der Frühphase für Regelungsvorhaben")}) (öffnet E-Mail)
...
In den umsetzungsorientierten Schulungen des Zentrum für Legistik lernen Sie Methoden und Werkzeuge kennen, die Sie bei der Erarbeitung von praxisnahen und bürokratiearmen Regelungen unterstützen.<br>
[Mitarbeiten an diesem Thema](${generateMailtoLink("Erweiterung der Schulungs-Angebote")}) (öffnet E-Mail)

### Ausbau der Regelungsbegleitung

Wir unterstützen Sie dabei, Umsetzungsprozesse zu verstehen und Anforderungen an praxisnahe und bürokratiearme Regelungen umzusetzen. Wir erweitern das Angebot in Inhalt und Umfang.<br>
[Mitarbeiten an diesem Thema](${generateMailtoLink("Ausbau der Regelungsbegleitung")}) (öffnet E-Mail)
`;

const offerings = `
## Verfügbare Angebote

*Die erste Version der Website des Zentrum für Legistik wurde am 05.01.2026 veröffentlicht.*
  ...
  return (
    <>
      ...
      <div className="breakout-grid">
        <div className="space-y-40 pt-0 pb-40 md:pb-80">
          <RichText
            className="mt-56 [&_h1]:mb-32 [&_h2]:mt-40 [&_h2]:mb-16"
            markdown={intro}
          />
        </div>
        <div className="bg-zfl-main20 breakout py-40 md:pb-80">
          <RichText
            className="mb-40 [&_h2]:mt-40 [&_h2]:mb-16"
            markdown={current}
          />
          <InfoBox className="bg-white" look="highlight">
            <RichText
              className="[&_h3]:mt-32 [&_h3]:first:mt-0"
              markdown={currentItems}
            />
          </InfoBox>
        </div>
