import{j as n}from"./tailwindMerge.BsTZoFyz.js";import{A as s}from"./AccordionItem.CHAbl4ow.js";import{H as d}from"./Hero.5KJXSSgU.js";import{M as u}from"./Meta.DxQ0q0lK.js";import{R as l}from"./plausibleUtils.DRsyqOyk.js";import{l as o,o as r,p as h}from"./routes.C0jth6p1.js";import{c as i}from"./contact.ByoLUVzx.js";import{d as e}from"./dedentMultilineStrings.CWXKGsTI.js";import{g as t}from"./tabs.9dE8jk0i.js";const g=[{headline:"Was bedeutet grenzüberschreitende Interoperabilität?",content:e`
          ...
          Die Grundlage bilden hierfür [digitaltaugliche Gesetze](${o.path}), die Interoperabilität unterstützen. Für Ihre Arbeit an Vorhaben sollte Interoperabilität in unterschiedlichen Dimensionen bewertet werden. Diese Dimensionen werden im European Interoperability Framework (EIF) definiert.
        `},{headline:"Wann besteht Interoperabilitäts-Bezug?",content:e`
          Interoperabilitäts-Bezug ist vorhanden, wenn:

          - eine (neue) [verbindliche Anforderung](${r.path}${t("hintergrund","verbindliche-anforderungen")}) definiert wird,
        ...
        `},{headline:"Was ist der europäische Interoperabilitätsrahmen (European Interoperability Framework EIF) und was beinhaltet er?",content:e`
          ...
          Der [Europäische Interoperabilitäts-Rahmen (EIF)](https://interoperable-europe.ec.europa.eu/collection/iopeu-monitoring/european-interoperability-framework-detail) definiert vier Ebenen der Interoperabilität, die bei der Gesetzgebung berücksichtigt werden müssen. Mehr dazu [hier](${r.path}${t("hintergrund","vier-ebenen-der-interoperabilitaet")}).
        `},{headline:"Was kommt bei der Interoperabilitäts-Bewertung auf mich zu?",content:e`
          ...
          Es geht darum, darzulegen, wie sich Ihre Regelung auf die EU-weite Interoperabilität auswirkt. Der wesentliche Inhalt besteht aus fünf Fragen. Die Bewertung fragt nach sogenannten „[verbindlichen Anforderungen](${r.path}${t("hintergrund","verbindliche-anforderungen")})“ und prüft deren Einfluss auf die [vier Ebenen der Interoperabilität](${r.path}${t("hintergrund","vier-ebenen-der-interoperabilitaet")}).
        ...
        `},{headline:'Was ist eine "Lösung für ein interoperables Europa" und was bringt mir das?',content:e`
          ...
          **Was bringt das für den Vollzug des Gesetzes?**
          ...
          - **Begründungspflicht:** Wenn Sie sich gegen eine markierte „Interoperable Europe Solution“ entscheiden, müssen Sie dies im Rahmen der Interoperabilitätsbewertung begründen.`}];function D(){return n.jsxs(n.Fragment,{children:[n.jsx(u,{prefix:h.title}),n.jsxs("main",{children:[n.jsx(d,{title:"Fragen und Antworten",children:n.jsx("p",{children:"In diesem Bereich erhalten Sie die wichtigsten Informationen zur Umsetzung der EU-Vorgaben für Interoperabilität, sowie zur Vorgehensweise beim Erarbeiten von Regelungen."})}),n.jsx("div",{className:"container mb-40 py-80",children:g.map(a=>n.jsx(s,{headline:a.headline,children:n.jsx(l,{markdown:a.content})},a.headline))})]})]})}export{D as default};
