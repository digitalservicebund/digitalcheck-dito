    ...
    **Verbindungspfeil**
    ...
    Pfeile verbinden die Symbole und machen die zeitliche Reihenfolge der Prozessschritte sichtbar.`}];function L(){const n=b.useRef(null);function a(){n.current?.closest("li")?.nextElementSibling?.scrollIntoView()}return e.jsx("div",{ref:n,className:"flex justify-center",children:e.jsx(S,{onClick:a,size:"small",iconLeft:e.jsx(B,{}),type:"button",children:"Nächster Schritt"})})}function m({mainContent:n,fullwidthContent:a,hideNextButton:l,id:u}){return e.jsx(p.Item,{className:"flex scroll-my-40 flex-col gap-16",after:e.jsxs(e.Fragment,{children:[a,!l&&e.jsx(L,{})]}),id:u,children:n})}function ie(){const n="px-16 sm:px-56",a={children:"Beispiel: Fahrerlaubnis",look:"hint"};return e.jsxs(e.Fragment,{children:[e.jsx(v,{prefix:A.title}),e.jsxs("main",{children:[e.jsx("div",{className:"breakout-grid-toc bg-blue-100 pt-40 pb-48",children:e.jsxs("div",{children:[e.jsx(c,{tagName:"h1",children:"Erstellung von Flussdiagrammen"}),e.jsx("p",{className:"ds-subhead mt-16",children:"Ein Flussdiagramm visualisiert, wie ein Prozess Schritt für Schritt abläuft. Es hilft, die Reihenfolge von z.B. Handlungen, Datenflüssen oder Entscheidungen übersichtlich darzustellen."})]})}),e.jsx(y,{sidebar:e.jsx(r,{title:"Inhalt",selector:"section[id], li[id]",children:e.jsxs(r.List,{className:"list-unstyled list-none",children:[e.jsx(r.Item,{href:"#aufbau",title:"Aufbau"}),e.jsx(r.Item,{href:"#anleitung",title:"Anleitung",after:e.jsxs(r.List,{className:"mt-0 list-none",children:[e.jsx(r.Item,{href:"#schritt-1",title:"Format",numbered:!0}),e.jsx(r.Item,{href:"#schritt-2",title:"Akteure",numbered:!0}),e.jsx(r.Item,{numbered:!0,href:"#schritt-3",title:"Ziel & Perspektive der Visualisierung"}),e.jsx(r.Item,{numbered:!0,href:"#schritt-4",title:"Start und Ende definieren"}),e.jsx(r.Item,{numbered:!0,href:"#schritt-5",title:"Prozess abbilden"}),e.jsx(r.Item,{numbered:!0,href:"#schritt-6",title:"Informationen ergänzen"})]})}),e.jsx(r.Item,{href:"#video-anleitung",title:"Video-Anleitung"})]})}),children:e.jsxs("div",{className:"my-40 space-y-40 lg:space-y-80",children:[e.jsxs("section",{className:"scroll-my-40 space-y-32 md:space-y-40",id:"aufbau",children:[e.jsx(c,{tagName:"h2",className:"ds-heading-02-reg",children:"Typischer Aufbau eines Flussdiagramms"}),e.jsx("div",{className:"grid grid-cols-1 gap-y-32 md:grid-cols-2 md:gap-x-48 md:gap-y-40",children:C.map(l=>e.jsxs("div",{className:"flex gap-8",children:[e.jsx("img",{src:l.iconUrl,alt:l.title,className:"size-80"}),e.jsx(s,{className:"ds-label-02-reg",markdown:l.description})]},l.title))}),e.jsx(d,{title:"Beispiel eines Flussdiagramms",image:{url:t("/images/methoden/flussdiagramme/flussdiagramm-beispiel.png"),caption:"In diesem Beispiel ist der Antragsprozess für einen Führerschein aus Sicht der Fahrschülerin / des Fahrschülers visualisiert.",alternativeText:"Das Bild zeigt am Beispiel des Führerscheinantrags, wie ein Flussdiagramm funktioniert. Es stellt alle Schritte von der Anmeldung bis zur Meldebestätigung in chronologischer Reihenfolge übersichtlich dar. Die grünen Boxen erklären die jeweiligen Vorteile. Ein Flussdiagramm veranschaulicht Prozesse, verdeutlicht Verantwortlichkeiten und hilft, die Orientierung über den gesamten Ablauf zu bewahren."},zoomable:!0,border:!0})]}),e.jsxs("section",{className:"scroll-my-40 space-y-32 md:space-y-40",id:"anleitung",children:[e.jsxs(c,{tagName:"h2",className:"flex gap-32",children:[e.jsx(w,{className:"size-40"}),"Anleitung"]}),e.jsxs(p,{separator:!0,children:[e.jsx(m,{id:"schritt-1",mainContent:e.jsxs(e.Fragment,{children:[e.jsx(h,{children:"Schritt 1"}),e.jsx(s,{markdown:i`
                    ...
                    **Darauf sollten Sie achten:**
                    ...
                    Schicken Sie uns eine E-Mail an ${N.email}.
