import{j as e}from"./tailwindMerge.gN6BWK24.js";import{y as f}from"./routes.BeebDdro.js";import{S as p}from"./DriveFileRenameOutline.B4ryBPcX.js";import h from"./AccordionItem.BBq0iTw8.js";import{B as u}from"./Badge.CVcnTeQT.js";import{a as l}from"./Button.fvDX-KZB.js";import{M as k,H as s}from"./Meta.BHpGBQkm.js";import{H as b}from"./Hero.V3yqlvY3.js";import{I as o}from"./ImageBox.BLosPChP.js";import{I as c}from"./InfoBox.CDtdaPok.js";import{N as g}from"./NewTabLink.CO3A7z9m.js";import{N as d}from"./NumberedList.BaqcWzEY.js";import{R as n}from"./RichText.BhR-Aseg.js";import i from"./TableOfContentsInteractive.BIXEUBVN.js";import{S as x}from"./SidebarContainer.DME9GLUO.js";import{a as t}from"./assetPath.BB2vIIN1.js";import{d as r}from"./dedentMultilineStrings.CWXKGsTI.js";const m=a=>e.jsxs("svg",Object.assign({xmlns:"http://www.w3.org/2000/svg",enableBackground:"new 0 0 24 24",height:24,viewBox:"0 0 24 24",width:24,"data-testid":"FeedOutlinedIcon",focusable:"false","aria-hidden":"true"},a,{children:[e.jsx("g",{children:e.jsx("path",{d:"M0,0h24v24H0V0z",fill:"none"})}),e.jsx("g",{children:e.jsx("path",{d:"M16,3H5C3.9,3,3,3.9,3,5v14c0,1.1,0.9,2,2,2h14c1.1,0,2-0.9,2-2V8L16,3z M19,19H5V5h10v4h4V19z M7,17h10v-2H7V17z M12,7H7 v2h5V7z M7,13h10v-2H7V13z"})})]}));function H(){const a="px-16 sm:px-56";return e.jsxs(e.Fragment,{children:[e.jsx(k,{prefix:f.title}),e.jsxs("main",{className:"space-y-80",children:[e.jsxs(b,{className:"mb-0 lg:mb-80",title:"Akteurinnen und Akteure identifizieren und Interviews vorbereiten",children:[e.jsx("p",{children:"Im folgenden Abschnitt finden Sie eine praxisnahe Anleitung zur strukturierten Vorbereitung und Durchführung von Interviews."}),e.jsx("p",{children:"Das Angebot wird derzeit weiterentwickelt, einschließlich der barrierefreien Optimierung der Vorlagen."}),e.jsx("p",{children:"Die Inhalte sind auf Basis von den unten aufgeführten Quellen entstanden."})]}),e.jsxs(x,{className:"space-y-80",sidebar:e.jsx(i,{title:"Inhalt",selector:"section[id], li[id]",children:e.jsxs(i.List,{className:"list-unstyled list-none",children:[e.jsx(i.Item,{href:"#anleitung",title:"Anleitung",after:e.jsxs(i.List,{className:"mt-0 list-none",children:[e.jsx(i.Item,{href:"#step-1",title:"Relevante Akteurinnen und Akteure identifizieren",numbered:!0}),e.jsx(i.Item,{href:"#step-2",title:"Halten Sie die Akteurinnen und Akteure in einer Übersicht fest",numbered:!0}),e.jsx(i.Item,{numbered:!0,href:"#step-3",title:"Gespräche durchführen"}),e.jsx(i.Item,{numbered:!0,href:"#step-4",title:"Auswerten"})]})}),e.jsx(i.Item,{href:"#checklist",title:"Checkliste"}),e.jsx(i.Item,{href:"#references",title:"Relevante Quellen"})]})}),children:[e.jsxs("section",{className:"container mt-80 space-y-40 lg:mt-0",id:"anleitung",children:[e.jsx("div",{children:e.jsxs(s,{tagName:"h2",className:"flex gap-32",children:[e.jsx(p,{className:"size-40"}),"Anleitung"]})}),e.jsxs(d,{className:"space-y-80",children:[e.jsxs(d.Item,{id:"step-1",after:e.jsxs(c,{className:a,look:"highlight",badge:{Icon:m,text:"Vorlage",look:"hint"},visual:{type:"component",Component:e.jsx(o,{image:{className:"min-w-208",url:t("/images/interview-leitfaden-vorlage.png"),alternativeText:"Eine Grafik, die eine beispielhafte Stakeholder-Map darstellt."}})},children:[e.jsx(n,{markdown:r`
                      **Stakeholder-Map:**
                    ...
                    `}),e.jsx(l,{look:"link",href:t("/documents/interview-leitfaden/Akteurlandschaft_Analyse.pptx"),children:"Powerpoint-Vorlage"})]}),children:[e.jsx(u,{children:"Schritt 1"}),e.jsx(s,{tagName:"h3",className:"mb-8",children:"Relevante Akteurinnen und Akteure identifizieren"}),e.jsx(n,{markdown:r`
                ...
                `})]}),e.jsxs(d.Item,{id:"step-2",after:e.jsxs("div",{className:"space-y-40",children:[e.jsxs(c,{className:a,look:"highlight",badge:{Icon:m,text:"Vorlage",look:"hint"},visual:{type:"component",Component:e.jsx(o,{image:{className:"min-w-208",url:t("/images/interview-leitfaden-vorlage-schritt-2.png"),alternativeText:"Eine Grafik, die eine beispielhafte Tabelle von Akteurinnen und Akteuren darstellt."}})},children:[e.jsx(n,{markdown:r`
                    ...
                    `}),e.jsx(l,{look:"link",href:t("/documents/interview-leitfaden/Umsetzung_verstehen.docx"),children:"Word-Vorlage"})]}),e.jsxs(c,{className:a,look:"highlight",badge:{Icon:m,text:"Vorlage",look:"hint"},visual:{type:"component",Component:e.jsx(o,{image:{className:"min-w-208",url:t("/images/interview-leitfaden-vorlage-buergercheck.png"),alternativeText:"Eine Grafik, die eine beispielhafte Tabelle zum besseren Verständnis von betroffenen Akteurinnen und Akteuren darstellt."}})},children:[e.jsx(n,{markdown:r`
                    ...
                    `}),e.jsx(l,{look:"link",href:t("/documents/interview-leitfaden/Zielgruppenanaylse-Buergercheck.pptx"),children:"Powerpoint-Vorlage"})]})]}),children:[e.jsx(u,{children:"Schritt 2"}),e.jsx(s,{tagName:"h3",className:"mb-8",children:"Halten Sie die Akteurinnen und Akteure in einer Übersicht fest"}),e.jsx(n,{markdown:r`
              ...
              `})]}),e.jsxs(d.Item,{className:"*:max-w-a11y",id:"step-3",children:[e.jsx(u,{children:"Schritt 3"}),e.jsx(s,{tagName:"h3",className:"mb-8",children:"Gespräche durchführen"}),e.jsx(n,{markdown:r`
              ...
              `}),e.jsx("br",{}),e.jsxs("p",{children:["Weiterführende Quelle:"," ",e.jsx(g,{href:"https://www.orghandbuch.de/SharedDocs/faqs/Webs/OHB/DE/Methoden_Befragung/13_Durchfuehrung_muendliches_Interview.html",children:"Orghandbuch des BMI 2026"})]}),e.jsx(s,{tagName:"h4",className:"ds-body-01-bold my-40",children:"Für die parallele Dokumentation bieten sich folgende Formen an:"}),e.jsx(h,{headline:"Wortgetreues Transkript",children:e.jsx(n,{markdown:r`
                ...
                `})}),e.jsx(h,{headline:"Inhaltsnahe Mitschrift / Ergebnisprotokoll",children:e.jsx(n,{markdown:r`
                ...
                `})}),e.jsx(h,{headline:"Audioaufzeichnung",children:e.jsx(n,{markdown:r`
                ...
                `})}),e.jsx(h,{headline:"Videoaufzeichnung",children:e.jsx(n,{markdown:r`
                ...
                `})})]}),e.jsxs(d.Item,{id:"step-4",children:[e.jsx(u,{children:"Schritt 4"}),e.jsx(s,{tagName:"h3",className:"mb-8",children:"Auswerten"}),e.jsx(n,{markdown:r`
              ...
              `})]})]})]}),e.jsx("hr",{className:"container"}),e.jsxs("section",{className:"container space-y-40",id:"checklist",children:[e.jsxs("div",{className:"space-y-8",children:[e.jsx(s,{tagName:"h2",children:"Alles auf einem Blick: Kompakte Checkliste zur Interviewführung"}),e.jsx("p",{children:"Nutzen Sie diese Zusammenfassung, um die methodische Qualität Ihrer Interviews abzusichern und eine lückenlose Vorbereitung sowie Nachbereitung sicherzustellen."})]}),e.jsxs(c,{className:a,look:"highlight",badge:{Icon:m,text:"Vorlage",look:"hint"},visual:{type:"component",Component:e.jsx(o,{image:{className:"min-w-208",url:t("/images/interview-leitfaden-checkliste.png"),alternativeText:"Eine Grafik, die einen Screenshot der Word-Checkliste darstellt."}})},children:[e.jsx(n,{markdown:r`
                Die Checkliste bündelt die wichtigsten Handlungsempfehlungen für Vorbereitung, Durchführung und Nachbereitung.
              `}),e.jsx(l,{look:"link",href:t("/documents/interview-leitfaden/Ablaufplan_Interviewführung.docx"),children:"Word-Vorlage"})]})]}),e.jsx("hr",{className:"container"}),e.jsxs("section",{className:"container space-y-8",id:"references",children:[e.jsx(s,{tagName:"h2",children:"Relevante Quellen"}),e.jsxs("ul",{children:[e.jsx("li",{children:e.jsx(g,{href:"https://www.oeffentliches-gestalten.de",children:"Öffentliches Gestalten"})}),e.jsx("li",{children:e.jsx(g,{href:"https://www.digitale-verwaltung.de/SharedDocs/downloads/Webs/DV/DE/servicehandbuch.pdf?__blob=publicationFile&v=5#page=18",children:"Servicehandbuch"})}),e.jsx("li",{children:e.jsx(g,{href:"https://servicestandard.gov.de/handbuch/#aus-der-praxis",children:"Servicestandard - Handbuch"})}),e.jsx("li",{children:e.jsx(l,{look:"link",href:t("/documents/interview-leitfaden/Buergercheck.pdf"),children:"Bürgercheck"})})]})]})]})]})]})}export{H as default};
