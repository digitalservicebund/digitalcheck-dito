import{t as e,z as t}from"./jsx-runtime-CWlP0OyB.js";import{A as n,F as r,I as i,O as a,Y as o,a as s,b as c,c as l,i as u,j as d,n as f,o as p,w as m,x as h}from"./routes-BpXvYPA_.js";import{t as g}from"./tabs-lhkPe3aT.js";import{t as _}from"./contact-BA-61OYP.js";import{t as v}from"./Meta-DYDKLG39.js";import{t as y}from"./Timeline-BFck3xUX.js";import{t as b}from"./dedentMultilineStrings-CRD88-o7.js";import{t as x}from"./ContentWrapper-BUwbCp2q.js";import{n as S}from"./Hero-oxrPA9uM.js";var C={title:`Das ist neu`,subtitle:b`
      ...
      Haben Sie Anregungen oder Wünsche? Kontaktieren Sie uns jederzeit gerne unter ${_.mdPhoneLink()} oder ${_.mdMailToLink(_.email,`Supportanfrage: digitalcheck.bund.de`)}.
  `,items:[{badge:{text:`20.05.2026`},content:b`
        Neue Seite: Gemeinsamer Digitalcheck für Bund und Länder
        
        [Hier ansehen](${s.path})`},{badge:{text:`11.05.2026`},content:b`
        ...
        [Hier ansehen](${l.path})`},{badge:{text:`30.03.2026`},content:b`
        ...
        [Hier ansehen](${m.path}${g(`interoperable-loesungen`,`interoperable-loesungen`)})`},{badge:{text:`26.03.2026`},content:b`
       ...
       - Neuer Inhalt: Beratungs- und Erfassungsprozess.
        ...
        [Hier ansehen](${u.path})
      `},{badge:{text:`16.03.2026`},content:b`
       Zusammenfassungen zu angrenzendem EU-Recht im Kontext des Interoperable Europe Act. Als Legist oder Legistin erfahren Sie: 
        ...
        [Hier ansehen](${m.path}${g(`angrenzendes-eu-recht`,`angrenzendes-eu-recht`)})
      `},{badge:{text:`13.02.2026`},content:b`
       Neuer Leitfaden: Praxis-Perspektive in Ihr Vorhaben einbinden
        ...
        [Hier ansehen](${d.path})
      `},{badge:{text:`28.01.2026`},content:b`
       Prinzipien der Digitaltauglichkeit:
        ...
        [Hier ansehen](${n.path})
      `},{badge:{text:`18.12.2025`},content:b`
      ...
      [Hier ansehen](${o.path})
      `},{badge:{text:`17.12.2025`},content:b`
      ...
      [Hier ansehen](${u.path})
      `},{badge:{text:`05.12.2025`},content:b`
      ...
      [Hier ansehen](${m.path}${g(`hintergrund`)})
      `},{badge:{text:`11.11.2025`},content:b`
       ...
       [Hier ansehen](${l.path})
      `},{badge:{text:`01.10.2025`},content:`Neues Beispiel ergänzt: SGB VI-Anpassungsgesetz (Einführung Fallmanagement DRV) [Hier ansehen](${f.path}/regelungen/sgb-vi-anpassungsgesetz-einfuehrung-fallmanagement-drv)`},{badge:{text:`12.09.2025`},content:`Anleitungs-Seite für Flussdiagramme: Video bei Schritt 5 ergänzt: Entstehen eines Flussdiagramms. [Hier ansehen](${i.path}#video-anleitung)`},{badge:{text:`12.09.2025`},content:b`
      ...
      `},{badge:{text:`11.09.2025`},content:`Darstellung der Progress-Bar an Style der Startseite angepasst`},{headline:{text:`Anleitungs-Seite für Flussdiagramme überarbeitet`},badge:{text:`04.09.2025`},content:b`
        ...
        [Hier ansehen](${i.path})
      `},{badge:{text:`01.09.2025`},content:b`
      ...
      `},{badge:{text:`26.08.2025`},content:b`
        ...
        - Neue [Einstiegseite / Landingpage für Visualisierungen](${r.path}) gelauncht
        - [NKR Infoseite](${h.path}) aktualisiert
      `},{badge:{text:`14.08.2025`},content:b`
        - Prinzipien-Seite
        ...
        [hier ansehen](${n.path})
      `},{badge:{text:`05.08.2025`},content:b`
        - Neue [Startseite](/)
        - Neue Grundlagen-Seite: Was ist [Digitaltauglichkeit](${c.path})?
        - Neue Grundlagen-Seite: [NKR und Digitalcheck](${h.path})
        ...
        - [Nationale Kontaktstelle-Seite](${a.path}): Zeitleiste neu sortiert (Aktuelles oben)
        - Versionsverlauf: Das PDF auf Digitale Verwaltung ist auf die Digitalcheck Website umgezogen und hat sich dabei in eine [Webpage](${p.path}) verwandelt
        - Der Methodenfahrplan in Grundlagen ist entfernt
      `},{headline:{text:`V1.5.1`},badge:{text:`31.07.2025`},content:b`
      ...
      `},{headline:{text:`Beispiele-Seite wieder online`},badge:{text:`12.06.2025`},content:`Die Beispiele wurden an die überarbeiteten Prinzipien angepasst und die Beispiel-Seite wieder online genommen.`},{headline:{text:`V1.5`},badge:{text:`02.06.2025`},content:b`
      ...
      `},{headline:{text:`V1.4`},badge:{text:`10.01.2025`},content:b`
      ...
      `},{headline:{text:`V1.3`},badge:{text:`21.05.2024`},content:b`
      ...
      `},{headline:{text:`V1.2`},badge:{text:`30.06.2023`},content:b`
      ...
      `},{headline:{text:`V1.1`},badge:{text:`27.01.2023`},content:b`
      ...
      `},{headline:{text:`V1.0`},badge:{text:`27.12.2022`},content:b`
        - Das PDF ist jetzt interaktiv ausfüllbar.
        - Alle Dokumente werden in einem Paket bereitgestellt
      `},{headline:{text:`V0.9`},badge:{text:`18.11.2022`},content:`Erste Version`}]},w=e(),T=t(function(){let e=C.items.map((e,t)=>({...e,hasBullet:!0,key:t,badge:{children:e.badge.text}}));return(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(v,{prefix:p.title}),(0,w.jsxs)(`main`,{children:[(0,w.jsx)(S,{title:C.title,subtitle:C.subtitle}),(0,w.jsx)(x,{children:(0,w.jsx)(y,{children:e.map(({key:e,...t})=>(0,w.jsx)(y.Item,{bullet:!0,children:(0,w.jsx)(y.ItemContent,{...t})},e))})})]})]})});export{T as default};