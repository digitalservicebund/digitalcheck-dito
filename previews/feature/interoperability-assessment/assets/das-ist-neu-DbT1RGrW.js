import{t as e,z as t}from"./jsx-runtime-CRNokwY0.js";import{C as n,G as r,L as i,N as a,T as o,U as s,W as c,X as l,et as u,h as d,i as f,it as p,k as m,w as h,z as g}from"./staticRoutes-CUPhJdiu.js";import{n as _,t as v}from"./contact-Tri1o3Mz.js";import{t as y}from"./Meta--KYJ5Wpq.js";import{t as b}from"./Timeline-B0X4bDVd.js";import{t as x}from"./ContentWrapper-B0oLb1b7.js";import{n as S}from"./Hero-DGlt8FW3.js";var C={title:`Das ist neu`,subtitle:_`
  ...
  `,items:[{badge:{text:`30.03.2026`},content:_`
        ...
        [Hier ansehen](${m.url}${p(`interoperable-loesungen`,`interoperable-loesungen`)})`},{badge:{text:`26.03.2026`},content:_`
      ...
      `},{badge:{text:`16.03.2026`},content:_`
       Zusammenfassungen zu angrenzendem EU-Recht im Kontext des Interoperable Europe Act. Als Legist oder Legistin erfahren Sie: 
        ...
        [Hier ansehen](${m.url}${p(`angrenzendes-eu-recht`,`angrenzendes-eu-recht`)})
      ...
      [Hier ansehen](${m.url}${p(`hintergrund`)})
      ...
      `},{badge:{text:`26.08.2025`},content:_`
        ...
        - Neue [Einstiegseite / Landingpage für Visualisierungen](${s.url}) gelauncht 
        - [NKR Infoseite](${o.url}) aktualisiert 
      ...
      `},{badge:{text:`05.08.2025`},content:_`
        - Neue [Startseite](/)
        - Neue Grundlagen-Seite: Was ist [Digitaltauglichkeit](${h.url})?
        - Neue Grundlagen-Seite: [NKR und Digitalcheck](${o.url})
        - Neue [Dokumentation als Word-Datei v1.5.1](${d.url}) aktualisiert auf Digitalcheck Website, Github und DV
        - Beispiele sind wieder im Footer verlinkt
        - [Nationale Kontaktstelle-Seite](${a.url}): Zeitleiste neu sortiert (Aktuelles oben)
        - Versionsverlauf: Das PDF auf Digitale Verwaltung ist auf die Digitalcheck Website umgezogen und hat sich dabei in eine [Webpage](${u.url}) verwandelt
      ...
      `},{headline:{text:`V0.9`},badge:{text:`18.11.2022`},content:`Erste Version`}]},w=e(),T=t(function(){let e=C.items.map((e,t)=>({...e,hasBullet:!0,key:t,badge:{children:e.badge.text}}));return(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(y,{prefix:u.title}),(0,w.jsxs)(`main`,{children:[(0,w.jsx)(S,{title:C.title,subtitle:C.subtitle}),(0,w.jsx)(x,{children:(0,w.jsx)(b,{children:e.map(({key:e,...t})=>(0,w.jsx)(b.Item,{bullet:!0,children:(0,w.jsx)(b.ItemContent,{...t})},e))})})]})]})});export{T as default};