import{w as m,j as n}from"./chunk-UVKPFVEO-D1_djuSg.js";import{C as p}from"./ContentWrapper-Cm3qCcqB.js";import{H as f}from"./Hero-CehFKQXQ.js";import{M as z}from"./Meta-DbldSXgK.js";import{T as r}from"./Timeline-Bt_NnmKF.js";import{n as k,E as g,j as a,g as s,t as d,F as D,s as o,G as w,f as E,u as A,H as h,a as S,I,C as V,J as b}from"./staticRoutes-EB1edRq7.js";import{d as e}from"./dedentMultilineStrings-CWXKGsTI.js";import{c as u}from"./contact-u1KNilBO.js";import"./tailwindMerge-IXz7yBTV.js";import"./Container-DbCzdLCl.js";import"./Heading-BZcaNK8Z.js";import"./RichText-Bh4xpFwt.js";import"./fileExtensionUtils-CXRZ7Pzr.js";import"./utilFunctions-CBG9PTYO.js";import"./OpenInNewIcon-lFZWn6XG.js";import"./index-BUtifBDb.js";import"./Badge-Cib9PIQm.js";import"./constants--3oyf-GA.js";import"./Button-R3L22qy0.js";import"./plausibleUtils-MJGLlQt3.js";import"./ImageZoomable-0qUl8cC5.js";import"./ZoomInOutlined-D4hWhzJg.js";import"./Image--T_7DWgE.js";import"./ButtonContainer-Js-H-5Us.js";const l={title:"Das ist neu",subtitle:e`
      ...
      Haben Sie Anregungen oder Wünsche? Kontaktieren Sie uns jederzeit gerne unter ${u.mdPhoneLink()} oder ${u.mdMailToLink(u.email,"Supportanfrage: digitalcheck.bund.de")}.
  `,items:[{badge:{text:"30.03.2026"},content:e`
        ...
        [Hier ansehen](${a.url}${s("interoperable-loesungen","interoperable-loesungen")})`},{badge:{text:"26.03.2026"},content:e`
       ...
       - Neuer Inhalt: Beratungs- und Erfassungsprozess.
        ...
        [Hier ansehen](${d.url})
      `},{badge:{text:"16.03.2026"},content:e`
       Zusammenfassungen zu angrenzendem EU-Recht im Kontext des Interoperable Europe Act. Als Legist oder Legistin erfahren Sie: 
        ...
        [Hier ansehen](${a.url}${s("angrenzendes-eu-recht","angrenzendes-eu-recht")})
      `},{badge:{text:"13.02.2026"},content:e`
       Neuer Leitfaden: Praxis-Perspektive in Ihr Vorhaben einbinden
        ...
        [Hier ansehen](${D.url})
      `},{badge:{text:"28.01.2026"},content:e`
       Prinzipien der Digitaltauglichkeit:
        ...
        [Hier ansehen](${o.url})
      `},{badge:{text:"18.12.2025"},content:e`
      ...
      [Hier ansehen](${w.url})
      `},{badge:{text:"17.12.2025"},content:e`
      ...
      [Hier ansehen](${d.url})
      `},{badge:{text:"05.12.2025"},content:e`
      ...
      [Hier ansehen](${a.url}${s("hintergrund")})
      `},{badge:{text:"11.11.2025"},content:e`
       ...
       [Hier ansehen](${E.url})
      `},{badge:{text:"01.10.2025"},content:`Neues Beispiel ergänzt: SGB VI-Anpassungsgesetz (Einführung Fallmanagement DRV) [Hier ansehen](${k.url}/sgb-vi-anpassungsgesetz-einfuehrung-fallmanagement-drv)`},{badge:{text:"12.09.2025"},content:`Anleitungs-Seite für Flussdiagramme: Video bei Schritt 5 ergänzt: Entstehen eines Flussdiagramms. [Hier ansehen](${g.url}#video-anleitung)`},{badge:{text:"12.09.2025"},content:e`
      ...
      `},{badge:{text:"11.09.2025"},content:"Darstellung der Progress-Bar an Style der Startseite angepasst"},{headline:{text:"Anleitungs-Seite für Flussdiagramme überarbeitet"},badge:{text:"04.09.2025"},content:e`
        ...
        [Hier ansehen](${g.url})
      `},{badge:{text:"01.09.2025"},content:e`
      ...
      `},{badge:{text:"26.08.2025"},content:e`
        ...
        - Neue [Einstiegseite / Landingpage für Visualisierungen](${A.url}) gelauncht 
        - [NKR Infoseite](${h.url}) aktualisiert 
      `},{badge:{text:"14.08.2025"},content:e`
        - Prinzipien-Seite
        ...
        [hier ansehen](${o.url})
      `},{badge:{text:"05.08.2025"},content:e`
        - Neue [Startseite](/)
        - Neue Grundlagen-Seite: Was ist [Digitaltauglichkeit](${S.url})?
        - Neue Grundlagen-Seite: [NKR und Digitalcheck](${h.url})
        - Neue [Dokumentation als Word-Datei v1.5.1](${I.url}) aktualisiert auf Digitalcheck Website, Github und DV
        - Beispiele sind wieder im Footer verlinkt
        - [Nationale Kontaktstelle-Seite](${V.url}): Zeitleiste neu sortiert (Aktuelles oben)
        - Versionsverlauf: Das PDF auf Digitale Verwaltung ist auf die Digitalcheck Website umgezogen und hat sich dabei in eine [Webpage](${b.url}) verwandelt
        - Der Methodenfahrplan in Grundlagen ist entfernt
      `},{headline:{text:"V1.5.1"},badge:{text:"31.07.2025"},content:e`
      ...
      `},{headline:{text:"Beispiele-Seite wieder online"},badge:{text:"12.06.2025"},content:"Die Beispiele wurden an die überarbeiteten Prinzipien angepasst und die Beispiel-Seite wieder online genommen."},{headline:{text:"V1.5"},badge:{text:"02.06.2025"},content:e`
      ...
      `},{headline:{text:"V1.4"},badge:{text:"10.01.2025"},content:e`
      ...
      `},{headline:{text:"V1.3"},badge:{text:"21.05.2024"},content:e`
      ...
      `},{headline:{text:"V1.2"},badge:{text:"30.06.2023"},content:e`
      ...
      `},{headline:{text:"V1.1"},badge:{text:"27.01.2023"},content:e`
      ...
      `},{headline:{text:"V1.0"},badge:{text:"27.12.2022"},content:e`
        - Das PDF ist jetzt interaktiv ausfüllbar.
        - Alle Dokumente werden in einem Paket bereitgestellt
      `},{headline:{text:"V0.9"},badge:{text:"18.11.2022"},content:"Erste Version"}]},q=m(function(){const c=l.items.map((t,i)=>({...t,hasBullet:!0,key:i,badge:{children:t.badge.text}}));return n.jsxs(n.Fragment,{children:[n.jsx(z,{prefix:b.title}),n.jsxs("main",{children:[n.jsx(f,{title:l.title,subtitle:l.subtitle}),n.jsx(p,{children:n.jsx(r,{children:c.map(({key:t,...i})=>n.jsx(r.Item,{bullet:!0,children:n.jsx(r.ItemContent,{...i})},t))})})]})]})});export{q as default};
