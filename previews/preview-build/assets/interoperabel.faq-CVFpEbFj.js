import{w as a,j as n}from"./chunk-UVKPFVEO-D1_djuSg.js";import{A as s}from"./AccordionItem-CsTz0Z41.js";import{H as d}from"./Hero-CehFKQXQ.js";import{M as u}from"./Meta-DbldSXgK.js";import{R as l}from"./RichText-Bh4xpFwt.js";import{c as i}from"./contact-u1KNilBO.js";import{R as o,a as h,g as r}from"./staticRoutes-EB1edRq7.js";import{d as e}from"./dedentMultilineStrings-CWXKGsTI.js";import"./tailwindMerge-IXz7yBTV.js";import"./plausibleUtils-MJGLlQt3.js";import"./disclosure-D8CBQGYV.js";import"./use-resolve-button-type-CCQueg8z.js";import"./open-closed-CGqt3hyD.js";import"./close-provider-U6ERXist.js";import"./Container-DbCzdLCl.js";import"./Heading-BZcaNK8Z.js";import"./fileExtensionUtils-CXRZ7Pzr.js";import"./utilFunctions-CBG9PTYO.js";import"./OpenInNewIcon-lFZWn6XG.js";import"./index-BUtifBDb.js";const g=[{headline:"Was bedeutet grenzüberschreitende Interoperabilität?",content:e`
          ...
          Die Grundlage bilden hierfür [digitaltaugliche Gesetze](${h.url}), die Interoperabilität unterstützen. Für Ihre Arbeit an Vorhaben sollte Interoperabilität in unterschiedlichen Dimensionen bewertet werden. Diese Dimensionen werden im European Interoperability Framework (EIF) definiert.
        `},{headline:"Wann besteht Interoperabilitäts-Bezug?",content:e`
          Interoperabilitäts-Bezug ist vorhanden, wenn:

          - eine (neue) [verbindliche Anforderung](${r("hintergrund","verbindliche-anforderungen")}) definiert wird,
        ...
        `},{headline:"Was sind „transeuropäische digitale öffentliche Dienste“?",content:e`
        ...
        `},{headline:"Ich setze eine EU-Verordnung oder -Richtlinie um, muss ich auch eine Bewertung einreichen?",content:e`
        ...
        `},{headline:"Wie hängen digitaltaugliche Regelungen und Interoperabilität zusammen?",content:e`
        ...
        `},{headline:"Was ist der europäische Interoperabilitätsrahmen (European Interoperability Framework EIF) und was beinhaltet er?",content:e`
          ...
          Der [Europäische Interoperabilitäts-Rahmen (EIF)](https://interoperable-europe.ec.europa.eu/collection/iopeu-monitoring/european-interoperability-framework-detail) definiert vier Ebenen der Interoperabilität, die bei der Gesetzgebung berücksichtigt werden müssen. Mehr dazu [hier](${r("hintergrund","vier-ebenen-der-interoperabilitaet")}).
        `},{headline:"Was kommt bei der Interoperabilitäts-Bewertung auf mich zu?",content:e`
          ...
          Es geht darum, darzulegen, wie sich Ihre Regelung auf die EU-weite Interoperabilität auswirkt. Der wesentliche Inhalt besteht aus fünf Fragen. Die Bewertung fragt nach sogenannten „[verbindlichen Anforderungen](${r("hintergrund","verbindliche-anforderungen")})“ und prüft deren Einfluss auf die [vier Ebenen der Interoperabilität](${r("hintergrund","vier-ebenen-der-interoperabilitaet")}).

          Wenn Sie weitere Fragen haben, dann kontaktieren Sie uns unter: ${i.mdMailToLink(i.interoperabilityEmail)} oder rufen Sie uns an unter ${i.mdPhoneLink()}.
        `},{headline:"Was ist das Ergebnis einer Interoperabilitätsbewertung?",content:e`
        ...
        `},{headline:"Welche Art von Unterstützung gibt es für die Durchführung von Interoperabilitätsbewertungen?",content:e`
        ...
        `},{headline:'Was ist eine "Lösung für ein interoperables Europa" und was bringt mir das?',content:e`
          ...
          **Was bringt das für den Vollzug des Gesetzes?**
          ...
          Die IT-Umsetzung Ihres Gesetzes wird erheblich günstiger und schneller, da Entwicklungsaufwand für individuelle Schnittstellen entfällt.`},{headline:'Muss ich eine "Lösung für einer interoperables Europa" zwingend vorschreiben?',content:e`
          ...
          - **Begründungspflicht:** Wenn Sie sich gegen eine markierte „Interoperable Europe Solution“ entscheiden, müssen Sie dies im Rahmen der Interoperabilitätsbewertung begründen.`}],W=a(function(){return n.jsxs(n.Fragment,{children:[n.jsx(u,{prefix:o.title}),n.jsxs("main",{children:[n.jsx(d,{title:"Fragen und Antworten",children:n.jsx("p",{children:"In diesem Bereich erhalten Sie die wichtigsten Informationen zur Umsetzung der EU-Vorgaben für Interoperabilität, sowie zur Vorgehensweise beim Erarbeiten von Regelungen."})}),n.jsx("div",{className:"container mb-40 py-80",children:g.map(t=>n.jsx(s,{headline:t.headline,children:n.jsx(l,{markdown:t.content})},t.headline))})]})]})});export{W as default};
