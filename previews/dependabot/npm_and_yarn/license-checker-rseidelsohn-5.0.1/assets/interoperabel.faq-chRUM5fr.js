import{t as e,z as t}from"./jsx-runtime-BDid30Hj.js";import{t as n}from"./RichText-D3mkylkV.js";import{m as r,v as i,y as a}from"./routes-Cj4mu4DZ.js";import{t as o}from"./tabs-lhkPe3aT.js";import{t as s}from"./contact-D1luJqfF.js";import{t as c}from"./Meta-BhKIhXE7.js";import{t as l}from"./AccordionItem-CZCkVQex.js";import{t as u}from"./dedentMultilineStrings-CRD88-o7.js";import{n as d}from"./Hero-CVfOqdma.js";var f=e(),p=[{headline:`Was bedeutet grenzüberschreitende Interoperabilität?`,content:u`
          ...
          Die Grundlage bilden hierfür [digitaltaugliche Gesetze](${r.path}), die Interoperabilität unterstützen. Für Ihre Arbeit an Vorhaben sollte Interoperabilität in unterschiedlichen Dimensionen bewertet werden. Diese Dimensionen werden im European Interoperability Framework (EIF) definiert.
        `},{headline:`Wann besteht Interoperabilitäts-Bezug?`,content:u`
          Interoperabilitäts-Bezug ist vorhanden, wenn:

          - eine (neue) [verbindliche Anforderung](${i.path}${o(`hintergrund`,`verbindliche-anforderungen`)}) definiert wird,
        ...
        `},{headline:`Was sind „transeuropäische digitale öffentliche Dienste“?`,content:u`
        ...
        `},{headline:`Ich setze eine EU-Verordnung oder -Richtlinie um, muss ich auch eine Bewertung einreichen?`,content:u`
        ...
        `},{headline:`Wie hängen digitaltaugliche Regelungen und Interoperabilität zusammen?`,content:u`
        ...
        `},{headline:`Was ist der europäische Interoperabilitätsrahmen (European Interoperability Framework EIF) und was beinhaltet er?`,content:u`
          ...
          Der [Europäische Interoperabilitäts-Rahmen (EIF)](https://interoperable-europe.ec.europa.eu/collection/iopeu-monitoring/european-interoperability-framework-detail) definiert vier Ebenen der Interoperabilität, die bei der Gesetzgebung berücksichtigt werden müssen. Mehr dazu [hier](${i.path}${o(`hintergrund`,`vier-ebenen-der-interoperabilitaet`)}).
        `},{headline:`Was kommt bei der Interoperabilitäts-Bewertung auf mich zu?`,content:u`
          ...
          Es geht darum, darzulegen, wie sich Ihre Regelung auf die EU-weite Interoperabilität auswirkt. Der wesentliche Inhalt besteht aus fünf Fragen. Die Bewertung fragt nach sogenannten „[verbindlichen Anforderungen](${i.path}${o(`hintergrund`,`verbindliche-anforderungen`)})“ und prüft deren Einfluss auf die [vier Ebenen der Interoperabilität](${i.path}${o(`hintergrund`,`vier-ebenen-der-interoperabilitaet`)}).

          Wenn Sie weitere Fragen haben, dann kontaktieren Sie uns unter: ${s.mdMailToLink(s.interoperabilityEmail)} oder rufen Sie uns an unter ${s.mdPhoneLink()}.
        `},{headline:`Was ist das Ergebnis einer Interoperabilitätsbewertung?`,content:u`
        ...
        `},{headline:`Welche Art von Unterstützung gibt es für die Durchführung von Interoperabilitätsbewertungen?`,content:u`
        ...
        `},{headline:`Was ist eine "Lösung für ein interoperables Europa" und was bringt mir das?`,content:u`
          ...
          **Was bringt das für den Vollzug des Gesetzes?**
          ...
          Die IT-Umsetzung Ihres Gesetzes wird erheblich günstiger und schneller, da Entwicklungsaufwand für individuelle Schnittstellen entfällt.`},{headline:`Muss ich eine "Lösung für einer interoperables Europa" zwingend vorschreiben?`,content:u`
          ...
          - **Begründungspflicht:** Wenn Sie sich gegen eine markierte „Interoperable Europe Solution“ entscheiden, müssen Sie dies im Rahmen der Interoperabilitätsbewertung begründen.`}],m=t(function(){return(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(c,{prefix:a.title}),(0,f.jsxs)(`main`,{children:[(0,f.jsx)(d,{title:`Fragen und Antworten`,children:(0,f.jsx)(`p`,{children:`In diesem Bereich erhalten Sie die wichtigsten Informationen zur Umsetzung der EU-Vorgaben für Interoperabilität, sowie zur Vorgehensweise beim Erarbeiten von Regelungen.`})}),(0,f.jsx)(`div`,{className:`container mb-40 py-80`,children:p.map(e=>(0,f.jsx)(l,{headline:e.headline,children:(0,f.jsx)(n,{markdown:e.content})},e.headline))})]})]})});export{m as default};