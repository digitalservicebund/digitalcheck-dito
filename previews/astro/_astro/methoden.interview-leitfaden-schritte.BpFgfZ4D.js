import{j as e}from"./tailwindMerge.B4_tS6rG.js";import{S as f}from"./DriveFileRenameOutline.el9mv5S4.js";import{A as u}from"./AccordionItem.-gHVOMzt.js";import{B as h}from"./Badge.CYu5pl0l.js";import{H as s,b as l}from"./ButtonContainer.BLS05-1e.js";import{H as p}from"./Hero.D6ixfnQb.js";import{I as o}from"./ImageBox.BqMUjFyh.js";import{I as c}from"./InfoBox.CqdhiH9W.js";import{N as g}from"./NewTabLink.DUwZbVhk.js";import{N as d}from"./NumberedList.DeU4bpMt.js";import{R as n}from"./RichText.rST1Op2y.js";import{S as k,T as r}from"./SidebarContainer.QJew3yRD.js";import{a as t}from"./assetPath.DYDS5rnC.js";import{d as i}from"./dedentMultilineStrings.CsdQtQqT.js";import{g as b}from"./featureFlags.server.BkZ_3Kpx.js";const m=a=>e.jsxs("svg",Object.assign({xmlns:"http://www.w3.org/2000/svg",enableBackground:"new 0 0 24 24",height:24,viewBox:"0 0 24 24",width:24,"data-testid":"FeedOutlinedIcon",focusable:"false","aria-hidden":"true"},a,{children:[e.jsx("g",{children:e.jsx("path",{d:"M0,0h24v24H0V0z",fill:"none"})}),e.jsx("g",{children:e.jsx("path",{d:"M16,3H5C3.9,3,3,3.9,3,5v14c0,1.1,0.9,2,2,2h14c1.1,0,2-0.9,2-2V8L16,3z M19,19H5V5h10v4h4V19z M7,17h10v-2H7V17z M12,7H7 v2h5V7z M7,13h10v-2H7V13z"})})]}));function R(){if(!b("showInterviewLeitfaden"))throw new Response("Not found",{status:404})}function T(){const a="px-16 sm:px-56";return e.jsx(e.Fragment,{children:e.jsxs("main",{className:"space-y-80",children:[e.jsxs(p,{className:"mb-0 lg:mb-80",title:"Akteurinnen und Akteure identifizieren und Interviews vorbereiten",children:[e.jsx("p",{children:"Im folgenden Abschnitt finden Sie eine praxisnahe Anleitung zur strukturierten Vorbereitung und Durchführung von Interviews."}),e.jsx("p",{children:"Das Angebot wird derzeit weiterentwickelt, einschließlich der barrierefreien Optimierung der Vorlagen."}),e.jsx("p",{children:"Die Inhalte sind auf Basis von den unten aufgeführten Quellen entstanden."})]}),e.jsxs(k,{className:"space-y-80",sidebar:e.jsx(r,{title:"Inhalt",selector:"section[id], li[id]",children:e.jsxs(r.List,{className:"list-unstyled list-none",children:[e.jsx(r.Item,{href:"#anleitung",title:"Anleitung",after:e.jsxs(r.List,{className:"mt-0 list-none",children:[e.jsx(r.Item,{href:"#step-1",title:"Relevante Akteurinnen und Akteure identifizieren",numbered:!0}),e.jsx(r.Item,{href:"#step-2",title:"Halten Sie die Akteurinnen und Akteure in einer Übersicht fest",numbered:!0}),e.jsx(r.Item,{numbered:!0,href:"#step-3",title:"Gespräche durchführen"}),e.jsx(r.Item,{numbered:!0,href:"#step-4",title:"Auswerten"})]})}),e.jsx(r.Item,{href:"#checklist",title:"Checkliste"}),e.jsx(r.Item,{href:"#references",title:"Relevante Quellen"})]})}),children:[e.jsxs("section",{className:"container mt-80 space-y-40 lg:mt-0",id:"anleitung",children:[e.jsx("div",{children:e.jsxs(s,{tagName:"h2",className:"flex gap-32",children:[e.jsx(f,{className:"size-40"}),"Anleitung"]})}),e.jsxs(d,{className:"space-y-80",children:[e.jsxs(d.Item,{id:"step-1",after:e.jsxs(c,{className:a,look:"highlight",badge:{Icon:m,text:"Vorlage",look:"hint"},visual:{type:"component",Component:e.jsx(o,{image:{className:"min-w-208",url:t("/images/interview-leitfaden-vorlage.png"),alternativeText:"Eine Grafik, die eine beispielhafte Stakeholder-Map darstellt."}})},children:[e.jsx(n,{markdown:i`
                    ...
                    `}),e.jsx(l,{look:"link",to:t("/documents/interview-leitfaden/Akteurlandschaft_Analyse.pptx"),children:"Powerpoint-Vorlage"})]}),children:[e.jsx(h,{children:"Schritt 1"}),e.jsx(s,{tagName:"h3",className:"mb-8",children:"Relevante Akteurinnen und Akteure identifizieren"}),e.jsx(n,{markdown:i`
                ...
                `})]}),e.jsxs(d.Item,{id:"step-2",after:e.jsxs("div",{className:"space-y-40",children:[e.jsxs(c,{className:a,look:"highlight",badge:{Icon:m,text:"Vorlage",look:"hint"},visual:{type:"component",Component:e.jsx(o,{image:{className:"min-w-208",url:t("/images/interview-leitfaden-vorlage-schritt-2.png"),alternativeText:"Eine Grafik, die eine beispielhafte Tabelle von Akteurinnen und Akteuren darstellt."}})},children:[e.jsx(n,{markdown:i`
                    ...
                    `}),e.jsx(l,{look:"link",to:t("/documents/interview-leitfaden/Zielgruppenanaylse-Buergercheck.pptx"),children:"Powerpoint-Vorlage"})]})]}),children:[e.jsx(h,{children:"Schritt 2"}),e.jsx(s,{tagName:"h3",className:"mb-8",children:"Halten Sie die Akteurinnen und Akteure in einer Übersicht fest"}),e.jsx(n,{markdown:i`
              ...
              `})]}),e.jsxs(d.Item,{className:"*:max-w-a11y",id:"step-3",children:[e.jsx(h,{children:"Schritt 3"}),e.jsx(s,{tagName:"h3",className:"mb-8",children:"Gespräche durchführen"}),e.jsx(n,{markdown:i`
              ...
              `}),e.jsx("br",{}),e.jsxs("p",{children:["Weiterführende Quelle:"," ",e.jsx(g,{to:"https://www.orghandbuch.de/SharedDocs/faqs/Webs/OHB/DE/Methoden_Befragung/13_Durchfuehrung_muendliches_Interview.html",children:"Orghandbuch des BMI 2026"})]}),e.jsx(s,{tagName:"h4",className:"ds-body-01-bold my-40",children:"Für die parallele Dokumentation bieten sich folgende Formen an:"}),e.jsx(u,{headline:"Wortgetreues Transkript",children:e.jsx(n,{markdown:i`
                ...
                `})})]}),e.jsxs(d.Item,{id:"step-4",children:[e.jsx(h,{children:"Schritt 4"}),e.jsx(s,{tagName:"h3",className:"mb-8",children:"Auswerten"}),e.jsx(n,{markdown:i`
              ...
              `})]})]})]}),e.jsx("hr",{className:"container"}),e.jsxs("section",{className:"container space-y-40",id:"checklist",children:[e.jsxs("div",{className:"space-y-8",children:[e.jsx(s,{tagName:"h2",children:"Alles auf einem Blick: Kompakte Checkliste zur Interviewführung"}),e.jsx("p",{children:"Nutzen Sie diese Zusammenfassung, um die methodische Qualität Ihrer Interviews abzusichern und eine lückenlose Vorbereitung sowie Nachbereitung sicherzustellen."})]}),e.jsxs(c,{className:a,look:"highlight",badge:{Icon:m,text:"Vorlage",look:"hint"},visual:{type:"component",Component:e.jsx(o,{image:{className:"min-w-208",url:t("/images/interview-leitfaden-checkliste.png"),alternativeText:"Eine Grafik, die einen Screenshot der Word-Checkliste darstellt."}})},children:[e.jsx(n,{markdown:i`
                Die Checkliste bündelt die wichtigsten Handlungsempfehlungen für Vorbereitung, Durchführung und Nachbereitung.
              `}),e.jsx(l,{look:"link",to:t("/documents/interview-leitfaden/Ablaufplan_Interviewführung.docx"),children:"Word-Vorlage"})]})]}),e.jsx("hr",{className:"container"}),e.jsxs("section",{className:"container space-y-8",id:"references",children:[e.jsx(s,{tagName:"h2",children:"Relevante Quellen"}),e.jsxs("ul",{children:[e.jsx("li",{children:e.jsx(g,{to:"https://www.oeffentliches-gestalten.de",children:"Öffentliches Gestalten"})}),e.jsx("li",{children:e.jsx(g,{to:"https://www.digitale-verwaltung.de/SharedDocs/downloads/Webs/DV/DE/servicehandbuch.pdf?__blob=publicationFile&v=5#page=18",children:"Servicehandbuch"})}),e.jsx("li",{children:e.jsx(g,{to:"https://servicestandard.gov.de/handbuch/#aus-der-praxis",children:"Servicestandard - Handbuch"})}),e.jsx("li",{children:e.jsx(l,{look:"link",to:t("/documents/interview-leitfaden/Buergercheck.pdf"),children:"Bürgercheck"})})]})]})]})]})})}export{T as default,R as loader};
