import{j as e,r as b,w,L as S}from"./chunk-OE4NN4TA-B87l8SeB.js";import{S as j}from"./ArrowCircleRightOutlined-DULS0GVg.js";import{S as v}from"./DriveFileRenameOutline---TgJJCM.js";import{S as z}from"./LayersOutlined-BZ5wKVPu.js";import{B as u}from"./Badge-Bfg24ddS.js";import{B as A}from"./Button-BtLr3ekH.js";import{H as c}from"./Heading-Db-0SMty.js";import{I as d}from"./ImageBox-Cwyy3l9D.js";import{I as m}from"./InfoBox-NN6_lNxk.js";import{N as p}from"./NumberedList-D44tib3y.js";import{R as i}from"./RichText-BajliK59.js";import{t as f}from"./tailwindMerge-DAhKV3eC.js";import{C as E}from"./Container-BhhaKIcM.js";import{M as F}from"./Meta-je4PDlaH.js";import{S as P,T as a}from"./SidebarContainer-BbP2kEJ7.js";import{S as g}from"./constants--3oyf-GA.js";import{c as y,d as n}from"./contact-IM88gR3s.js";import{I as N,U as I,c as B}from"./staticRoutes-DxOXiJjV.js";import{a as r}from"./assetPath-CYz_OR4C.js";import{g as D}from"./plausibleUtils-MJGLlQt3.js";import"./fileExtensionUtils-CXRZ7Pzr.js";import"./Image-g_t_n92O.js";import"./ImageZoomable-oA59qruA.js";import"./ZoomInOutlined-D7uvyS4f.js";import"./ButtonContainer-Ct0mUTvK.js";import"./DetailsSummary-CUqUabo5.js";import"./utilFunctions-CBG9PTYO.js";import"./OpenInNewIcon-DlPLIjTI.js";import"./index-c8EPsgkm.js";const V=s=>e.jsxs("svg",Object.assign({xmlns:"http://www.w3.org/2000/svg",height:24,viewBox:"0 0 24 24",width:24,"data-testid":"ArrowDownwardOutlinedIcon",focusable:"false","aria-hidden":"true"},s,{children:[e.jsx("path",{d:"M0 0h24v24H0V0z",fill:"none"}),e.jsx("path",{d:"M20 12l-1.41-1.41L13 16.17V4h-2v12.17l-5.58-5.59L4 12l8 8 8-8z"})]})),C=s=>e.jsxs("svg",Object.assign({xmlns:"http://www.w3.org/2000/svg",height:24,viewBox:"0 0 24 24",width:24,"data-testid":"ArrowUpwardIcon",focusable:"false","aria-hidden":"true"},s,{children:[e.jsx("path",{d:"M0 0h24v24H0V0z",fill:"none"}),e.jsx("path",{d:"M4 12l1.41 1.41L11 7.83V20h2V7.83l5.58 5.59L20 12l-8-8-8 8z"})]}));function T(){const[s,t]=b.useState(!1),l=()=>{const x=window.innerHeight,k=window.scrollY>x;t(k)},o=()=>{window.scrollTo({top:0,behavior:"smooth"})};return b.useEffect(()=>(window.addEventListener("scroll",l),()=>{window.removeEventListener("scroll",l)}),[]),e.jsxs("button",{onClick:o,className:f("ds-label-03-reg fixed right-16 bottom-16 z-50 flex items-center gap-8 rounded-full bg-blue-800 p-8 pr-16 text-white shadow-md outline-2 outline-blue-500 transition-opacity duration-150 sm:right-24 sm:bottom-24",s?"opacity-100":"pointer-events-none opacity-0"),"aria-hidden":!s,tabIndex:s?void 0:-1,children:[e.jsx(C,{fill:"currentColor"}),"Zurück nach oben"]})}const L=[{iconUrl:r("/icons/DiagramStartNode.svg"),title:"Start-/Endsymbol",description:n`
        **Start-/Endsymbol**
        
        Der Kreis stellt den Beginn oder das Ende eines Prozesses dar (z.B. Antrag wird gestellt).`},{iconUrl:r("/icons/DiagramDecision.svg"),title:"Entscheidungssymbol",description:n`
        **Entscheidungssymbol**
        
        Eine Raute steht für eine Abfrage mit mindestens zwei möglichen Ausgängen (z.B. Antrag vollständig? – ja/nein).`},{iconUrl:r("/icons/DiagramActor.svg"),title:"Akteurin/Akteur",description:n`
      **Akteurin/Akteur**
      
      Ein Rechteck mit Symbol steht für eine beteiligte Person oder Institution im Prozess (z.B. Meldebehörde oder Fahrschülerin).`},{iconUrl:r("/icons/DiagramData.svg"),title:"Datensymbol (Eingabe/Ausgabe)",description:n`
    **Datensymbol (Eingabe/Ausgabe)**
    
    Dieses Symbol zeigt genutzte oder erzeugte Daten oder Ressourcen (z.B. Melderegister).`},{iconUrl:r("/icons/DiagramActivity.svg"),title:"Prozess-/Aktivitätssymbol",description:n`
    **Prozess-/Aktivitätssymbol**
    
    Das Rechteck stellt eine Aktivität oder einen Arbeitsschritt dar (z.B. Antrag prüfen).`},{iconUrl:r("/icons/DiagramConnector.svg"),title:"Verbindungspfeil",description:n`
    **Verbindungspfeil**
    
    Pfeile verbinden die Symbole und machen die zeitliche Reihenfolge der Prozessschritte sichtbar.`}];function R(){const s=b.useRef(null);function t(){s.current?.closest("li")?.nextElementSibling?.scrollIntoView()}return e.jsx("div",{ref:s,className:"flex justify-center",children:e.jsx(A,{onClick:t,size:"small",iconLeft:e.jsx(V,{}),type:"button",children:"Nächster Schritt"})})}function h({mainContent:s,fullwidthContent:t,hideNextButton:l,id:o}){return e.jsx(p.Item,{className:"flex scroll-my-40 flex-col gap-16",after:e.jsxs(e.Fragment,{children:[t,!l&&e.jsx(R,{})]}),id:o,children:s})}const ge=w(function(){const t="px-16 sm:px-56",l={children:"Beispiel: Fahrerlaubnis",look:"hint"};return e.jsxs(e.Fragment,{children:[e.jsx(F,{prefix:N.title}),e.jsxs("main",{children:[e.jsx("div",{className:"breakout-grid-toc bg-blue-100 pt-40 pb-48",children:e.jsxs("div",{children:[e.jsx(c,{tagName:"h1",children:"Erstellung von Flussdiagrammen"}),e.jsx("p",{className:"ds-subhead mt-16",children:"Ein Flussdiagramm visualisiert, wie ein Prozess Schritt für Schritt abläuft. Es hilft, die Reihenfolge von z.B. Handlungen, Datenflüssen oder Entscheidungen übersichtlich darzustellen."})]})}),e.jsx(P,{sidebar:e.jsx(a,{title:"Inhalt",selector:"section[id], li[id]",children:e.jsxs(a.List,{className:"list-unstyled list-none",children:[e.jsx(a.Item,{href:"#aufbau",title:"Aufbau"}),e.jsx(a.Item,{href:"#anleitung",title:"Anleitung",after:e.jsxs(a.List,{className:"mt-0 list-none",children:[e.jsx(a.Item,{href:"#schritt-1",title:"Format",numbered:!0}),e.jsx(a.Item,{href:"#schritt-2",title:"Akteure",numbered:!0}),e.jsx(a.Item,{numbered:!0,href:"#schritt-3",title:"Ziel & Perspektive der Visualisierung"}),e.jsx(a.Item,{numbered:!0,href:"#schritt-4",title:"Start und Ende definieren"}),e.jsx(a.Item,{numbered:!0,href:"#schritt-5",title:"Prozess abbilden"}),e.jsx(a.Item,{numbered:!0,href:"#schritt-6",title:"Informationen ergänzen"})]})}),e.jsx(a.Item,{href:"#video-anleitung",title:"Video-Anleitung"})]})}),children:e.jsxs("div",{className:"my-40 space-y-40 lg:space-y-80",children:[e.jsxs("section",{className:"scroll-my-40 space-y-32 md:space-y-40",id:"aufbau",children:[e.jsx(c,{tagName:"h2",className:"ds-heading-02-reg",children:"Typischer Aufbau eines Flussdiagramms"}),e.jsx("div",{className:"grid grid-cols-1 gap-y-32 md:grid-cols-2 md:gap-x-48 md:gap-y-40",children:L.map(o=>e.jsxs("div",{className:"flex gap-8",children:[e.jsx("img",{src:o.iconUrl,alt:o.title,className:"size-80"}),e.jsx(i,{className:"ds-label-02-reg",markdown:o.description})]},o.title))}),e.jsx(d,{title:"Beispiel eines Flussdiagramms",image:{url:r("/images/methoden/flussdiagramme/flussdiagramm-beispiel.png"),caption:"In diesem Beispiel ist der Antragsprozess für einen Führerschein aus Sicht der Fahrschülerin / des Fahrschülers visualisiert.",alternativeText:"Das Bild zeigt am Beispiel des Führerscheinantrags, wie ein Flussdiagramm funktioniert. Es stellt alle Schritte von der Anmeldung bis zur Meldebestätigung in chronologischer Reihenfolge übersichtlich dar. Die grünen Boxen erklären die jeweiligen Vorteile. Ein Flussdiagramm veranschaulicht Prozesse, verdeutlicht Verantwortlichkeiten und hilft, die Orientierung über den gesamten Ablauf zu bewahren."},zoomable:!0,border:!0})]}),e.jsxs("section",{className:"scroll-my-40 space-y-32 md:space-y-40",id:"anleitung",children:[e.jsxs(c,{tagName:"h2",className:"flex gap-32",children:[e.jsx(v,{className:"size-40"}),"Anleitung"]}),e.jsxs(p,{separator:!0,children:[e.jsx(h,{id:"schritt-1",mainContent:e.jsxs(e.Fragment,{children:[e.jsx(u,{children:"Schritt 1"}),e.jsx(i,{markdown:n`
                    ...
                    **Darauf sollten Sie achten:**
                    ...
                    `})]}),fullwidthContent:e.jsx(m,{look:"highlight",className:t,badge:{Icon:z,children:"Vorlage für Flussdiagramm"},children:e.jsx(i,{markdown:n`
                  ...
                  `})})}),e.jsx(h,{id:"schritt-2",mainContent:e.jsxs(e.Fragment,{children:[e.jsx(u,{children:"Schritt 2"}),e.jsx(i,{markdown:n`
                      ...
                      Es ist nicht schlimm, wenn Sie dabei einen Akteur vergessen. Dieser kann später hinzugefügt werden.`})]}),fullwidthContent:e.jsx(m,{look:"highlight",className:t,badge:l,visual:{type:"component",Component:e.jsx(d,{image:{url:r("/images/methoden/flussdiagramme/2/relevante-akteure.png"),alternativeText:"Eine Grafik, welches die Institutionen Meldebehörde, Anerkannte Prüfstelle (Fahrschule), Bundesdruckerei, Bundesamt für Justiz sowie die Rolle Fahrschüler:in ungeordnet darstellt."}})},children:e.jsx(i,{markdown:n`
              ...
              `}),e.jsx(d,{image:{url:r("/images/methoden/flussdiagramme/4/start-ende.png"),caption:"Der Start markiert die erste Aktion eines Akteurs, das Ende die letzte.",alternativeText:"Darstellung von Start- und Endknoten"},zoomable:!1,border:!0})]}),fullwidthContent:e.jsx(m,{look:"highlight",className:t,badge:l,visual:{type:"component",Component:e.jsx(d,{image:{url:r("/images/methoden/flussdiagramme/4/beispiel-fahrschule-start-ende.png"),alternativeText:"Ausschnitt eines Flussdiagramms: Start des Prozesses durch einen Kreis mit dünner Linie für den Akteur Fahrschüler:in. Zwei dick umrandete Kreise zeigen verschiedene mögliche Endergebnisse."}})},children:e.jsx(i,{markdown:n`
                    Am Beispiel der Fahrerlaubnis:
              ...
              `}),e.jsx(d,{image:{url:r("/images/methoden/flussdiagramme/5/schwimmbahnen.png"),alternativeText:"Fragment eines Flussdiagramms mit drei horizontalen, länglichen Kästen, die am Anfang mit einer Platzhalter-Box “Akteurin/Akteur” markiert sind.",caption:"Akteure können alle Normenadressaten oder Institutionen sein.",className:"border border-blue-800"},className:"md:max-w-2/3 lg:max-w-1/2",zoomable:!1,border:!0}),e.jsx("p",{children:"Setzen Sie den Startpunkt an den Anfang der Bahn des Akteurs, den Endpunkt ans Ende. Der genaue Platz wird im Verlauf noch angepasst. Der genaue Punkt findet sich später. Fügen Sie nun Aktivitäten, Entscheidungen und Informationsflüsse der Akteure nacheinander in die Bahnen ein. Formulieren Sie die Aktivitäten möglichst aktiv, z. B. „Akteur X beantragt Y“ oder „Akteur X versendet Y“."}),e.jsx(d,{image:{url:r("/images/methoden/flussdiagramme/5/aktivitäten-mit-pfeilen.png"),alternativeText:"Fragment eines Flussdiagramms, in denen Kästen für Aktivitäten mit Pfeilen verbunden sind.",caption:"Jede Aktivität der Akteure wird mit einem Pfeil verbunden."},className:"md:max-w-2/3 lg:max-w-1/2",zoomable:!1,border:!0}),e.jsx(i,{markdown:n`
                    **Darauf sollten Sie achten:**
                    ...
                    `}),e.jsx("p",{className:"ds-label-02-reg text-gray-900",id:"flussdiagramm-erstellen-live-desc",children:"Ein Beispielvideo zeigt das Entstehen eines Flussdiagramms."})]}),fullwidthContent:e.jsx(m,{look:"highlight",className:t,badge:l,visual:{type:"component",Component:e.jsx(d,{image:{url:r("/images/methoden/flussdiagramme/5/beispiel-fahrschule-kombiniert.png"),alternativeText:"Flussdiagramm, welches Aktivitäten für Akteure Fahrschüler:in, Anerkannte Prüfstelle (Fahrschule) sowie Meldebehörde in farblich unterschiedlich kodierten Schwimmbahnen wie im Text beschrieben darstellt."}})},children:e.jsx(i,{markdown:n`
                ...
                `}),e.jsx(d,{image:{url:r("/images/methoden/flussdiagramme/6/legende.png"),alternativeText:"Eine Legende, die zu Symbolen aus dem Diagramm Beschriftungen ergänzt",caption:"Eine Legende erklärt Symbole und Abkürzungen und macht so die Visualisierung verständlich."},border:!0,className:"md:max-w-2/3 lg:max-w-1/2"}),e.jsx(i,{markdown:n`
                    ...
                    `})]}),fullwidthContent:e.jsx(m,{look:"highlight",className:t,badge:l,visual:{type:"component",Component:e.jsx(d,{image:{url:r("/images/methoden/flussdiagramme/6/vollständiges-beispiel.jpg"),alternativeText:"Flussdiagramm, welches zusätzliche Entscheidungssymbole, ein Datenbank-Symbol sowie eine Legende enthält."}})},children:e.jsx(i,{markdown:n`
