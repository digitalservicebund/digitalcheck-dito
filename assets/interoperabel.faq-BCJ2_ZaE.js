import{t as e,z as t}from"./jsx-runtime-TdnDAAmO.js";import{t as n}from"./RichText-DT0SOT3o.js";import{E as r,T as i,b as a,et as o}from"./staticRoutes-BHUqHp-T.js";import{n as s,t as c}from"./contact-CfI4JXHd.js";import{t as l}from"./Meta-Br9VxYMg.js";import{t as u}from"./AccordionItem-D4_bd1lB.js";import{n as d}from"./Hero-BsfHI65Y.js";var f=e(),p=[{headline:`Was bedeutet grenzüberschreitende Interoperabilität?`,content:s`
          ...
          Die Grundlage bilden hierfür [digitaltaugliche Gesetze](${a.url}), die Interoperabilität unterstützen. Für Ihre Arbeit an Vorhaben sollte Interoperabilität in unterschiedlichen Dimensionen bewertet werden. Diese Dimensionen werden im European Interoperability Framework (EIF) definiert.
        `},{headline:`Wann besteht Interoperabilitäts-Bezug?`,content:s`
          Interoperabilitäts-Bezug ist vorhanden, wenn:

          - eine (neue) [verbindliche Anforderung](${i.url}${o(`hintergrund`,`verbindliche-anforderungen`)}) definiert wird,
        ...
        `},{headline:`Was sind „transeuropäische digitale öffentliche Dienste“?`,content:s`
        ...
        `},{headline:`Ich setze eine EU-Verordnung oder -Richtlinie um, muss ich auch eine Bewertung einreichen?`,content:s`
        ...
        `},{headline:`Wie hängen digitaltaugliche Regelungen und Interoperabilität zusammen?`,content:s`
        ...
        `},{headline:`Was ist der europäische Interoperabilitätsrahmen (European Interoperability Framework EIF) und was beinhaltet er?`,content:s`
          ...
          Der [Europäische Interoperabilitäts-Rahmen (EIF)](https://interoperable-europe.ec.europa.eu/collection/iopeu-monitoring/european-interoperability-framework-detail) definiert vier Ebenen der Interoperabilität, die bei der Gesetzgebung berücksichtigt werden müssen. Mehr dazu [hier](${o(`hintergrund`,`vier-ebenen-der-interoperabilitaet`)}).
        `},{headline:`Was kommt bei der Interoperabilitäts-Bewertung auf mich zu?`,content:s`
          ...
          Es geht darum, darzulegen, wie sich Ihre Regelung auf die EU-weite Interoperabilität auswirkt. Der wesentliche Inhalt besteht aus fünf Fragen. Die Bewertung fragt nach sogenannten „[verbindlichen Anforderungen](${o(`hintergrund`,`verbindliche-anforderungen`)})“ und prüft deren Einfluss auf die [vier Ebenen der Interoperabilität](${o(`hintergrund`,`vier-ebenen-der-interoperabilitaet`)}).

          Wenn Sie weitere Fragen haben, dann kontaktieren Sie uns unter: ${c.mdMailToLink(c.interoperabilityEmail)} oder rufen Sie uns an unter ${c.mdPhoneLink()}.
        `},{headline:`Was ist das Ergebnis einer Interoperabilitätsbewertung?`,content:s`
        ...
        `},{headline:`Welche Art von Unterstützung gibt es für die Durchführung von Interoperabilitätsbewertungen?`,content:s`
        ...
        `},{headline:`Was ist eine "Lösung für ein interoperables Europa" und was bringt mir das?`,content:s`
          ...
          **Was bringt das für den Vollzug des Gesetzes?**
          ...
          Die IT-Umsetzung Ihres Gesetzes wird erheblich günstiger und schneller, da Entwicklungsaufwand für individuelle Schnittstellen entfällt.`},{headline:`Muss ich eine "Lösung für einer interoperables Europa" zwingend vorschreiben?`,content:s`
          ...
          - **Begründungspflicht:** Wenn Sie sich gegen eine markierte „Interoperable Europe Solution“ entscheiden, müssen Sie dies im Rahmen der Interoperabilitätsbewertung begründen.`}],m=t(function(){return(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(l,{prefix:r.title}),(0,f.jsxs)(`main`,{children:[(0,f.jsx)(d,{title:`Fragen und Antworten`,children:(0,f.jsx)(`p`,{children:`In diesem Bereich erhalten Sie die wichtigsten Informationen zur Umsetzung der EU-Vorgaben für Interoperabilität, sowie zur Vorgehensweise beim Erarbeiten von Regelungen.`})}),(0,f.jsx)(`div`,{className:`container mb-40 py-80`,children:p.map(e=>(0,f.jsx)(u,{headline:e.headline,children:(0,f.jsx)(n,{markdown:e.content})},e.headline))})]})]})});export{m as default};