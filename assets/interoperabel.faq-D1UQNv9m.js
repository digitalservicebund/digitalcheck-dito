import{t as e,z as t}from"./jsx-runtime-CWlP0OyB.js";import{t as n}from"./RichText-D7P1cnkP.js";import{T as r,b as i,w as a}from"./routes-BpXvYPA_.js";import{t as o}from"./tabs-lhkPe3aT.js";import{t as s}from"./contact-BA-61OYP.js";import{t as c}from"./Meta-DYDKLG39.js";import{t as l}from"./AccordionItem-EjBzpwt9.js";import{t as u}from"./dedentMultilineStrings-CRD88-o7.js";import{n as d}from"./Hero-oxrPA9uM.js";var f=e(),p=[{headline:`Was bedeutet grenzüberschreitende Interoperabilität?`,content:u`
          ...
          Die Grundlage bilden hierfür [digitaltaugliche Gesetze](${i.path}), die Interoperabilität unterstützen. Für Ihre Arbeit an Vorhaben sollte Interoperabilität in unterschiedlichen Dimensionen bewertet werden. Diese Dimensionen werden im European Interoperability Framework (EIF) definiert.
        `},{headline:`Wann besteht Interoperabilitäts-Bezug?`,content:u`
          Interoperabilitäts-Bezug ist vorhanden, wenn:

          - eine (neue) [verbindliche Anforderung](${a.path}${o(`hintergrund`,`verbindliche-anforderungen`)}) definiert wird,
        ...
        `},{headline:`Was ist der europäische Interoperabilitätsrahmen (European Interoperability Framework EIF) und was beinhaltet er?`,content:u`
          ...
          Der [Europäische Interoperabilitäts-Rahmen (EIF)](https://interoperable-europe.ec.europa.eu/collection/iopeu-monitoring/european-interoperability-framework-detail) definiert vier Ebenen der Interoperabilität, die bei der Gesetzgebung berücksichtigt werden müssen. Mehr dazu [hier](${a.path}${o(`hintergrund`,`vier-ebenen-der-interoperabilitaet`)}).
        `},{headline:`Was kommt bei der Interoperabilitäts-Bewertung auf mich zu?`,content:u`
          ...
          Es geht darum, darzulegen, wie sich Ihre Regelung auf die EU-weite Interoperabilität auswirkt. Der wesentliche Inhalt besteht aus fünf Fragen. Die Bewertung fragt nach sogenannten „[verbindlichen Anforderungen](${a.path}${o(`hintergrund`,`verbindliche-anforderungen`)})“ und prüft deren Einfluss auf die [vier Ebenen der Interoperabilität](${a.path}${o(`hintergrund`,`vier-ebenen-der-interoperabilitaet`)}).
