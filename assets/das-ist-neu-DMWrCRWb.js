import{t as e,z as t}from"./jsx-runtime-qDrv0oV-.js";import{$ as n,B as r,G as i,M as a,O as o,P as s,R as c,Y as l,b as u,i as d,u as f,v as p,w as m,y as h,z as g}from"./staticRoutes-j8ffinMg.js";import{n as _,t as v}from"./contact-dnZfsXSv.js";import{t as y}from"./Meta-uTfJy3It.js";import{t as b}from"./Timeline-ha4VA62Z.js";import{t as x}from"./ContentWrapper-BFEJ426V.js";import{n as S}from"./Hero-DI5O80dh.js";var C={title:`Das ist neu`,subtitle:_`
  ...
  `,items:[{badge:{text:`30.03.2026`},content:_`
        ...
        [Hier ansehen](${m.url}${n(`interoperable-loesungen`,`interoperable-loesungen`)})`},{badge:{text:`26.03.2026`},content:_`
      ...
      `},{badge:{text:`16.03.2026`},content:_`
       Zusammenfassungen zu angrenzendem EU-Recht im Kontext des Interoperable Europe Act. Als Legist oder Legistin erfahren Sie: 
        ...
        [Hier ansehen](${m.url}${n(`angrenzendes-eu-recht`,`angrenzendes-eu-recht`)})
      ...
      [Hier ansehen](${m.url}${n(`hintergrund`)})
      ...
      `},{badge:{text:`26.08.2025`},content:_`
        ...
        - Neue [Einstiegseite / Landingpage für Visualisierungen](${c.url}) gelauncht 
        - [NKR Infoseite](${u.url}) aktualisiert 
      ...
      `},{badge:{text:`05.08.2025`},content:_`
        ...
        - Neue Grundlagen-Seite: [NKR und Digitalcheck](${u.url})
        - Neue [Dokumentation als Word-Datei v1.5.1](${f.url}) aktualisiert auf Digitalcheck Website, Github und DV
        - Beispiele sind wieder im Footer verlinkt
        - [Nationale Kontaktstelle-Seite](${o.url}): Zeitleiste neu sortiert (Aktuelles oben)
        - Versionsverlauf: Das PDF auf Digitale Verwaltung ist auf die Digitalcheck Website umgezogen und hat sich dabei in eine [Webpage](${l.url}) verwandelt
      ...
      `},{headline:{text:`V0.9`},badge:{text:`18.11.2022`},content:`Erste Version`}]},w=e(),T=t(function(){let e=C.items.map((e,t)=>({...e,hasBullet:!0,key:t,badge:{children:e.badge.text}}));return(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(y,{prefix:l.title}),(0,w.jsxs)(`main`,{children:[(0,w.jsx)(S,{title:C.title,subtitle:C.subtitle}),(0,w.jsx)(x,{children:(0,w.jsx)(b,{children:e.map(({key:e,...t})=>(0,w.jsx)(b.Item,{bullet:!0,children:(0,w.jsx)(b.ItemContent,{...t})},e))})})]})]})});export{T as default};