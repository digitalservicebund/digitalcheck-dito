import{t as e,z as t}from"./jsx-runtime-TdnDAAmO.js";import{B as n,F as r,K as i,N as a,T as o,V as s,X as c,b as l,d as u,et as d,i as f,k as p,x as m,y as h,z as g}from"./staticRoutes-BHUqHp-T.js";import{n as _,t as v}from"./contact-CfI4JXHd.js";import{t as y}from"./Meta-Br9VxYMg.js";import{t as b}from"./Timeline-DeBNjnDa.js";import{t as x}from"./ContentWrapper-C2-Ap9aO.js";import{n as S}from"./Hero-BsfHI65Y.js";var C={title:`Das ist neu`,subtitle:_`
      ...
      Haben Sie Anregungen oder Wünsche? Kontaktieren Sie uns jederzeit gerne unter ${v.mdPhoneLink()} oder ${v.mdMailToLink(v.email,`Supportanfrage: digitalcheck.bund.de`)}.
  `,items:[{badge:{text:`30.03.2026`},content:_`
        ...
        [Hier ansehen](${o.url}${d(`interoperable-loesungen`,`interoperable-loesungen`)})`},{badge:{text:`26.03.2026`},content:_`
       ...
       - Neuer Inhalt: Beratungs- und Erfassungsprozess.
        ...
        [Hier ansehen](${h.url})
      `},{badge:{text:`16.03.2026`},content:_`
       Zusammenfassungen zu angrenzendem EU-Recht im Kontext des Interoperable Europe Act. Als Legist oder Legistin erfahren Sie: 
        ...
        [Hier ansehen](${o.url}${d(`angrenzendes-eu-recht`,`angrenzendes-eu-recht`)})
      `},{badge:{text:`13.02.2026`},content:_`
       Neuer Leitfaden: Praxis-Perspektive in Ihr Vorhaben einbinden
        ...
        [Hier ansehen](${a.url})
      `},{badge:{text:`28.01.2026`},content:_`
       Prinzipien der Digitaltauglichkeit:
        ...
        [Hier ansehen](${r.url})
      `},{badge:{text:`18.12.2025`},content:_`
      ...
      [Hier ansehen](${s.url})
      `},{badge:{text:`17.12.2025`},content:_`
      ...
      [Hier ansehen](${h.url})
      `},{badge:{text:`05.12.2025`},content:_`
      ...
      [Hier ansehen](${o.url}${d(`hintergrund`)})
      `},{badge:{text:`11.11.2025`},content:_`
      ...
      `},{badge:{text:`11.09.2025`},content:`Darstellung der Progress-Bar an Style der Startseite angepasst`},{headline:{text:`Anleitungs-Seite für Flussdiagramme überarbeitet`},badge:{text:`04.09.2025`},content:_`
        ...
        [Hier ansehen](${n.url})
      `},{badge:{text:`01.09.2025`},content:_`
      ...
      `},{badge:{text:`26.08.2025`},content:_`
        ...
        - Neue [Einstiegseite / Landingpage für Visualisierungen](${g.url}) gelauncht 
        - [NKR Infoseite](${m.url}) aktualisiert 
      `},{badge:{text:`14.08.2025`},content:_`
        - Prinzipien-Seite
        ...
        [hier ansehen](${r.url})
      `},{badge:{text:`05.08.2025`},content:_`
        - Neue [Startseite](/)
        - Neue Grundlagen-Seite: Was ist [Digitaltauglichkeit](${l.url})?
        - Neue Grundlagen-Seite: [NKR und Digitalcheck](${m.url})
        - Neue [Dokumentation als Word-Datei v1.5.1](${u.url}) aktualisiert auf Digitalcheck Website, Github und DV
        - Beispiele sind wieder im Footer verlinkt
        - [Nationale Kontaktstelle-Seite](${p.url}): Zeitleiste neu sortiert (Aktuelles oben)
        - Versionsverlauf: Das PDF auf Digitale Verwaltung ist auf die Digitalcheck Website umgezogen und hat sich dabei in eine [Webpage](${c.url}) verwandelt
        - Der Methodenfahrplan in Grundlagen ist entfernt
      `},{headline:{text:`V1.5.1`},badge:{text:`31.07.2025`},content:_`
      ...
      `},{headline:{text:`Beispiele-Seite wieder online`},badge:{text:`12.06.2025`},content:`Die Beispiele wurden an die überarbeiteten Prinzipien angepasst und die Beispiel-Seite wieder online genommen.`},{headline:{text:`V1.5`},badge:{text:`02.06.2025`},content:_`
      ...
      `},{headline:{text:`V1.4`},badge:{text:`10.01.2025`},content:_`
      ...
      `},{headline:{text:`V1.3`},badge:{text:`21.05.2024`},content:_`
      ...
      `},{headline:{text:`V1.2`},badge:{text:`30.06.2023`},content:_`
      ...
      `},{headline:{text:`V1.1`},badge:{text:`27.01.2023`},content:_`
      ...
      `},{headline:{text:`V1.0`},badge:{text:`27.12.2022`},content:_`
        - Das PDF ist jetzt interaktiv ausfüllbar.
        - Alle Dokumente werden in einem Paket bereitgestellt
      `},{headline:{text:`V0.9`},badge:{text:`18.11.2022`},content:`Erste Version`}]},w=e(),T=t(function(){let e=C.items.map((e,t)=>({...e,hasBullet:!0,key:t,badge:{children:e.badge.text}}));return(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(y,{prefix:c.title}),(0,w.jsxs)(`main`,{children:[(0,w.jsx)(S,{title:C.title,subtitle:C.subtitle}),(0,w.jsx)(x,{children:(0,w.jsx)(b,{children:e.map(({key:e,...t})=>(0,w.jsx)(b.Item,{bullet:!0,children:(0,w.jsx)(b.ItemContent,{...t})},e))})})]})]})});export{T as default};