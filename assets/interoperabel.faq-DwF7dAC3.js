import{t as e,z as t}from"./jsx-runtime-CRNokwY0.js";import{t as n}from"./RichText-DKKXOV5K.js";import{A as r,it as i,k as a,w as o}from"./staticRoutes-CUPhJdiu.js";import{n as s,t as c}from"./contact-Tri1o3Mz.js";import{t as l}from"./Meta--KYJ5Wpq.js";import{t as u}from"./AccordionItem-ej-rKl-F.js";import{n as d}from"./Hero-DGlt8FW3.js";var f=e(),p=[{headline:`Was bedeutet grenzüberschreitende Interoperabilität?`,content:s`
        ...
        `},{headline:`Wann besteht Interoperabilitäts-Bezug?`,content:s`
          ...
          - eine (neue) [verbindliche Anforderung](${a.url}${i(`hintergrund`,`verbindliche-anforderungen`)}) definiert wird,
        ...
        `},{headline:`Was ist der europäische Interoperabilitätsrahmen (European Interoperability Framework EIF) und was beinhaltet er?`,content:s`
          ...
          Der [Europäische Interoperabilitäts-Rahmen (EIF)](https://interoperable-europe.ec.europa.eu/collection/iopeu-monitoring/european-interoperability-framework-detail) definiert vier Ebenen der Interoperabilität, die bei der Gesetzgebung berücksichtigt werden müssen. Mehr dazu [hier](${i(`hintergrund`,`vier-ebenen-der-interoperabilitaet`)}).
        `},{headline:`Was kommt bei der Interoperabilitäts-Bewertung auf mich zu?`,content:s`
          ...
          Es geht darum, darzulegen, wie sich Ihre Regelung auf die EU-weite Interoperabilität auswirkt. Der wesentliche Inhalt besteht aus fünf Fragen. Die Bewertung fragt nach sogenannten „[verbindlichen Anforderungen](${i(`hintergrund`,`verbindliche-anforderungen`)})“ und prüft deren Einfluss auf die [vier Ebenen der Interoperabilität](${i(`hintergrund`,`vier-ebenen-der-interoperabilitaet`)}).
