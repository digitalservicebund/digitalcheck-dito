...
export default function Footer() {
  return (
    <footer
      id="footer"
      className="ds-label-03-reg border-blue-300 text-gray-900 flex w-full flex-row justify-center border-t-2 leading-snug print:hidden"
    ...
    >
      <div className="kern-stack kern-stack-xl sm:kern-stack-2xl w-full max-w-6xl px-16 py-40">
        ...
        <hr className="border-blue-300 mt-16 w-full border-t-2" />
