import type { InfoBoxProps } from "@/components/InfoBox.tsx";
...
export default function MethodCard({
  ...
  return (
    <div className="overflow-hidden rounded-lg">
      <div className="bg-ds-blue-300 px-20 pt-40 sm:px-96 sm:pt-44">
...
const MethodCardInfoBox = (props: InfoBoxProps) => (
  <InfoBox
    {...props}
    className="bg-ds-blue-100 px-16 py-24 sm:px-80 sm:pt-40 sm:pb-48"
  />
);
