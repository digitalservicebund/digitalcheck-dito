  ...
  return (
    <li className="group my-2 [&>ol]:pl-16">
      <a
        ...
        className={twMerge(
          "link-unstyled",
          "ds-link-02-reg text-blue-800 hover:bg-blue-300 focus-visible:outline-blue-800 data-active:border-l-blue-800 data-active:bg-blue-200 data-active:hover:bg-blue-300 block cursor-pointer border-l-4 border-transparent p-8 no-underline focus-visible:outline-4 focus-visible:outline-offset-4",
          numberClass,
        )}
      >
        {title}
