  ...
  return (
    <div className="relative mb-4 ml-4 inline-flex flex-row items-center align-middle">
      ...
      <div
        ...
        role="tooltip"
        className={twJoin(
          "ds-label-03-reg border-blue-300 bg-blue-100 text-gray-900 absolute w-160 rounded-sm border px-12 py-8 transition-opacity duration-300",
      ...
      >
        ...
        <span
          className={twJoin(
            "border-blue-300 bg-blue-100 absolute h-12 w-12 rotate-45 border",
