...
function ToggleTabButton({
  ...
  return (
    <Button
      ...
      look="tertiary"
      className={twJoin("fill-blue-800 w-auto p-6", className)}
      onClick={onClick}
    >
      {children}
    </Button>
    ...
    <>
      ...
      <div
        className={customTwMerge(
          // Base (desktop grid)
          "help border-blue-300 relative border-l bg-white",
          !isOpen && "hidden",
            ...
            >
              <div className="w-full space-y-32 pr-16 pl-32">
                {sections.map((section) => (
                  ...
                  >
                    <h3 className="kern-title text-blue-800 mb-8 font-bold">
                      {section.title}
                    </h3>
